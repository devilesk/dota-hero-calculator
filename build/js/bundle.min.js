...
},{"./herocalc_abilitydata":19,"./herocalc_knockout":20}],2:[function(require,module,exports){
...
},{"./AbilityModel":1,"./buffs/buffOptionsArray":4,"./buffs/debuffOptionsArray":5,"./herocalc_knockout":20,"./inventory/InventoryViewModel":25,"./util/findWhere":36}],3:[function(require,module,exports){
...
},{"../util/getJSON":37,"../util/isEmpty":38}],7:[function(require,module,exports){
...
},{"../herocalc_knockout":20,"../util/extend":35,"./DamageTypeColor":8}],10:[function(require,module,exports){
...
},{"../AbilityModel":1,"../BuffViewModel":2,"../herocalc_knockout":20,"../inventory/InventoryViewModel":25,"./HeroDamageMixin":9,"./diffProperties":15,"./nextLevelExp":17,"./totalExp":18}],11:[function(require,module,exports){
...
},{"../illusion/illusionData":22,"../util/findWhere":36,"./HeroModel":10}],13:[function(require,module,exports){
...
},{"../AbilityModel":1,"../herocalc_knockout":20,"./HeroModel":10}],14:[function(require,module,exports){
...
},{"./HeroOption":11}],17:[function(require,module,exports){
...
},{"../lib/knockout.mapping":43,"../lib/knockout.wrap":44}],21:[function(require,module,exports){
...
},{"./IllusionOption":21,"./illusionData":22}],24:[function(require,module,exports){
...
},{"../herocalc_knockout":20,"./BasicInventoryViewModel":24,"./itemBuffOptions":27,"./itemDebuffOptions":28,"./itemOptionsArray":29,"./levelItems":31,"./stackableItems":32}],26:[function(require,module,exports){
...
},{"./AbilityModel":1,"./BuffViewModel":2,"./buffs/buffOptionsArray":4,"./buffs/debuffOptionsArray":5,"./data/main":6,"./hero/CloneModel":7,"./hero/HeroModel":10,"./hero/IllusionModel":12,"./hero/UnitModel":13,"./hero/heroOptionsArray":16,"./inventory/InventoryViewModel":25,"./inventory/itemBuffOptions":27,"./inventory/itemDebuffOptions":28,"./inventory/itemOptionsArray":29,"./util/main":39}],35:[function(require,module,exports){
...
},{"./extend":35,"./findWhere":36,"./getJSON":37,"./union":40,"./uniqueId":41,"./uniques":42}],40:[function(require,module,exports){
...
},{"./herocalc_knockout":78,"dota-hero-calculator-library":34,"dota-hero-calculator-library/src/herocalc/AbilityModel":1,"dota-hero-calculator-library/src/herocalc/inventory/BasicInventoryViewModel":24,"dota-hero-calculator-library/src/herocalc/util/union":40}],70:[function(require,module,exports){
(function (global){
...
},{"./DamageAmpViewModel":71,"./HeroDamageAmpMixin":73,"dota-hero-calculator-library":34}],71:[function(require,module,exports){
...
},{"./herocalc_knockout":78,"dota-hero-calculator-library/src/herocalc/BuffViewModel":2,"dota-hero-calculator-library/src/herocalc/buffs/BuffModel":3,"dota-hero-calculator-library/src/herocalc/util/findWhere":36}],72:[function(require,module,exports){
(function (global){
...
},{"../components/shop":84,"./CloneViewModel":70,"./HeroViewModel":74,"./UnitViewModel":76,"./herocalc_knockout":78,"./herocalc_tooltips_ability":79,"./herocalc_tooltips_item":80,"./jquery-ui.custom":81,"dota-hero-calculator-library":34,"dota-hero-calculator-library/src/herocalc/AbilityModel":1,"dota-hero-calculator-library/src/herocalc/data/main":6,"dota-hero-calculator-library/src/herocalc/inventory/levelItems":31,"dota-hero-calculator-library/src/herocalc/inventory/stackableItems":32,"dota-hero-calculator-library/src/herocalc/util/findWhere":36,"dota-hero-calculator-library/src/herocalc/util/uniqueId":41}],73:[function(require,module,exports){
...
},{"./herocalc_knockout":78,"dota-hero-calculator-library":34,"dota-hero-calculator-library/src/herocalc/data/main":6,"dota-hero-calculator-library/src/herocalc/illusion/illusionData":22,"dota-hero-calculator-library/src/herocalc/util/findWhere":36}],76:[function(require,module,exports){
(function (global){
...
},{"dota-hero-calculator-library":34,"dota-hero-calculator-library/src/herocalc/hero/UnitOption":14}],77:[function(require,module,exports){
...
},{"chart.js":45}],86:[function(require,module,exports){
(function (global){
require("./app/polyfill");var Rollbar=require("rollbar-browser"),$="undefined"!=typeof window?window.$:"undefined"!=typeof global?global.$:null,getParameterByName=require("./app/getParameterByName"),HeroCalc=require("dota-hero-calculator-library"),App=function(e){function r(e){l.length>10&&l.shift(),l.push(e)}function t(e,t){return function(){var a=this,o={eventName:t};a.id&&(o.id=a.id),a.src&&(o.src=a.src),a.className&&(o.className=a.className),a.textContent&&(o.textContent=a.textContent),a.nodeName&&(o.nodeName=a.nodeName),a.getAttribute("data-bind")&&(o["data-bind"]=a.getAttribute("data-bind"));for(var n in o)o.hasOwnProperty(n)&&(o[n]=o[n].substring(0,Math.min(200,o[n].length)));return r(o),e.apply(this,arguments)}}function a(e,r,t,a,o){var n=e[r];return e[r]=function(){return o.indexOf(arguments[0])!=-1&&(arguments[t]=a(arguments[t],arguments[0])),n.apply(this,arguments)},n}HeroCalc.init(null,null,null,function(){var r=require("./app/HeroCalculatorViewModel"),t=new r(e.abilityTooltipPath);ko.options.deferUpdates=!0,ko.applyBindings(t),$("#spinner").hide(),$(".initial-hidden").css("display","inline-block"),$("#popHero0").addClass("active"),$("#heroPane0").addClass("active"),$('[data-toggle="tooltip"]').tooltip();var a=getParameterByName("id");a&&$.get("save/"+a+".json",function(e){t.load(e)})});var o="#DEV_BUILD";$("#last-update").text(o);var n={accessToken:"de1980fcab4849d6a7a066cf098a6521",captureUncaught:!0,payload:{environment:"development",client:{javascript:{source_map_enabled:!0,code_version:"#code_version",guess_uncaught_frames:!0}}}},i=Rollbar.init(n);$(".error-warning-view, .error-warning-close").click(function(){$(".error-warning").fadeOut(200)});var l=[];a(Element.prototype,"addEventListener",1,t,["click","focus","blur","change","dblclick"]),window.onerror=function(e){return function(){var r={},t=document.querySelector("#log");if(t)try{var a=arguments[0],o=document.createElement("div");o.classList.add("alert"),o.classList.add("alert-danger"),o.classList.add("error-log"),o.classList.add("col-md-12"),o.textContent="error: "+a;var n=document.createElement("div");n.classList.add("error-log-close"),n.innerHTML="&times;",n.onclick=function(){t.removeChild(o)},o.appendChild(n);var d=document.createElement("a");d.classList.add("error-log-link"),d.innerHTML="Send error report",d.href="#",d.onclick=function(){$("#myModal").modal("show"),$("#BugReportFormText").text("error: "+a+"\n\nDescribe what you were doing. Try to be as detailed as possible.")},o.appendChild(d),t.appendChild(o),$(".error-warning").fadeOut(200).fadeIn(100)}catch(e){i.error("window.onerror create error log failed.",e)}else r.clientLogCreated=!1;if(HeroCalculatorViewModel&&viewModel){try{r.heroCalcState=viewModel.getSaveData()}catch(e){i.error("window.onerror getSaveData failed.",e)}try{r.appState=viewModel.getAppState()}catch(e){i.error("window.onerror getAppState failed.",e)}}else r.appState="load failed";return r.userActions=l,i.configure({payload:{custom:r}}),e.apply(this,arguments)}}(window.onerror)};module.exports=App;
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})

},{"./app/HeroCalculatorViewModel":72,"./app/getParameterByName":77,"./app/polyfill":83,"dota-hero-calculator-library":34,"rollbar-browser":68}]},{},[86])(86)
});
