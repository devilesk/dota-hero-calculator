...
"use strict";var ko=require("../herocalc_knockout"),stackableItems=require("./stackableItems"),levelItems=require("./levelItems"),BasicInventoryViewModel=require("./BasicInventoryViewModel"),itemOptionsArray=require("./itemOptionsArray"),itemBuffOptions=require("./itemBuffOptions"),itemDebuffOptions=require("./itemDebuffOptions"),InventoryViewModel=function(e,t){var a=this;return BasicInventoryViewModel.call(this,t),a.hero=t,a.hasInventory=ko.observable(!0),a.items=ko.observableArray([]),a.activeItems=ko.observableArray([]),a.hasScepter=ko.computed(function(){for(var e=0;e<a.items().length;e++){var t=a.items()[e].item;if("ultimate_scepter"===t&&a.items()[e].enabled())return!0}return!1},this),a.isEthereal=ko.computed(function(){for(var e=0;e<a.items().length;e++){var t=a.items()[e].item,i=a.activeItems.indexOf(a.items()[e])>=0;if(("ghost"===t||"ethereal_blade"===t)&&a.items()[e].enabled()&&i)return!0}return!1},this),a.isSheeped=ko.computed(function(){for(var e=0;e<a.items().length;e++){var t=a.items()[e].item,i=a.activeItems.indexOf(a.items()[e])>=0;if("sheepstick"===t&&a.items()[e].enabled()&&i)return!0}return!1},this),a.totalCost=ko.computed(function(){for(var t=0,i=0;i<a.items().length;i++){var s=a.items()[i].item;if(a.items()[i].enabled())if(stackableItems.indexOf(s)!=-1)t+=e["item_"+s].itemcost*a.items()[i].size;else if(levelItems.indexOf(s)!=-1)switch(s){case"diffusal_blade":t+=e["item_"+s].itemcost+700*(a.items()[i].size-1);break;case"necronomicon":case"dagon":t+=e["item_"+s].itemcost+1250*(a.items()[i].size-1);break;default:t+=e["item_"+s].itemcost}else t+=e["item_"+s].itemcost}return t},this),a.addItemBuff=function(e,t){if(a.hasInventory()&&void 0!=a.selectedItemBuff()){var i={item:a.selectedItemBuff(),state:ko.observable(0),size:1,enabled:ko.observable(!0)};a.items.push(i),"ring_of_aquila"!==a.selectedItemBuff()&&"ring_of_basilius"!==a.selectedItemBuff()||a.toggleItem(void 0,i,void 0)}},a.addItemDebuff=function(e,t){if(a.hasInventory()&&void 0!=a.selectedItemDebuff()){var i={item:a.selectedItemDebuff().split("|")[0],state:ko.observable(0),size:1,enabled:ko.observable(!0)};2==a.selectedItemDebuff().split("|").length&&(i.debuff=a.selectedItemDebuff().split("|")[1]),a.items.push(i),"ring_of_aquila"!==a.selectedItemDebuff()&&"ring_of_basilius"!==a.selectedItemDebuff()||a.toggleItem(void 0,i,void 0)}},a.getAttributes=function(t){for(var i=0,s=0;s<a.items().length;s++){var r=a.items()[s].item,n=a.activeItems.indexOf(a.items()[s])>=0;if(a.items()[s].enabled())for(var m=a.items()[s].size,u=0;u<e["item_"+r].attributes.length;u++){var o=e["item_"+r].attributes[u];switch(o.name){case"bonus_all_stats":i+=parseInt(o.value[0]);break;case"bonus_stats":i+=parseInt(o.value[0])}switch(t){case"agi":"bonus_agility"==o.name&&(i+="diffusal_blade"==r?parseInt(o.value[m-1]):parseInt(o.value[0])),"bonus_stat"==o.name&&2==a.items()[s].state()&&(i+=parseInt(o.value[0])),"bonus_agi"==o.name&&(i+=parseInt(o.value[0]));break;case"int":"bonus_intellect"==o.name&&(i+="necronomicon"==r?parseInt(o.value[m-1]):"diffusal_blade"==r?parseInt(o.value[m-1]):"dagon"==r?parseInt(o.value[m-1]):parseInt(o.value[0])),"bonus_intelligence"==o.name&&(i+=parseInt(o.value[0])),"bonus_int"==o.name&&(i+=parseInt(o.value[0])),"bonus_stat"==o.name&&1==a.items()[s].state()&&(i+=parseInt(o.value[0]));break;case"str":"bonus_strength"==o.name&&(i+="necronomicon"==r?parseInt(o.value[m-1]):parseInt(o.value[0])),"bonus_stat"==o.name&&0==a.items()[s].state()&&(i+=parseInt(o.value[0])),"bonus_str"==o.name&&(i+=parseInt(o.value[0])),"unholy_bonus_strength"==o.name&&n&&(i+=parseInt(o.value[0]))}}}return i},a.getBash=function(t){for(var i=1,s=0;s<a.items().length;s++){var r=a.items()[s].item;if(a.items()[s].enabled())for(var n=0;n<e["item_"+r].attributes.length;n++){var m=e["item_"+r].attributes[n];switch(m.name){case"bash_chance":i*=1-parseInt(m.value[0])/100;break;case"bash_chance_melee":"DOTA_UNIT_CAP_MELEE_ATTACK"==t&&(i*=1-parseInt(m.value[0])/100);break;case"bash_chance_ranged":"DOTA_UNIT_CAP_RANGED_ATTACK"==t&&(i*=1-parseInt(m.value[0])/100)}}}return i},a.getCritChance=function(){for(var t=1,i=0;i<a.items().length;i++){var s=a.items()[i].item;a.activeItems.indexOf(a.items()[i])>=0;if(a.items()[i].enabled())for(var r=0;r<e["item_"+s].attributes.length;r++){var n=e["item_"+s].attributes[r];switch(n.name){case"crit_chance":t*=1-parseInt(n.value[0])/100}}}return t},a.getCritSource=function(){for(var t={},i=0;i<a.items().length;i++){var s=a.items()[i].item,r=a.activeItems.indexOf(a.items()[i])>=0;if(a.items()[i].enabled()){switch(s){case"lesser_crit":case"greater_crit":case"bloodthorn":void 0==t[s]?t[s]={chance:a.getItemAttributeValue(e["item_"+s].attributes,"crit_chance",0)/100,multiplier:a.getItemAttributeValue(e["item_"+s].attributes,"crit_multiplier",0)/100,count:1,displayname:e["item_"+s].displayname}:t[s].count+=1}"bloodthorn"===s&&r&&(void 0==t.soul_rend?t.soul_rend={chance:1,multiplier:a.getItemAttributeValue(e["item_"+s].attributes,"target_crit_multiplier",0)/100,count:1,displayname:"Soul Rend"}:t.soul_rend.count+=1)}}return t},a.getCleaveSource=function(){for(var t={},i=0;i<a.items().length;i++){var s=a.items()[i].item;a.activeItems.indexOf(a.items()[i])>=0;if(a.items()[i].enabled())switch(s){case"bfury":void 0==t[s]?t[s]={radius:a.getItemAttributeValue(e["item_"+s].attributes,"cleave_radius",0),magnitude:a.getItemAttributeValue(e["item_"+s].attributes,"cleave_damage_percent",0)/100,count:1,displayname:e["item_"+s].displayname}:t[s].count+=1}}return t},a.getBashSource=function(t){for(var i={},s=0;s<a.items().length;s++){var r=a.items()[s].item;a.activeItems.indexOf(a.items()[s])>=0;if(a.items()[s].enabled())switch(r){case"javelin":void 0==i[r]?i[r]={damage:a.getItemAttributeValue(e["item_"+r].attributes,"bonus_chance_damage",1),damageType:"magic",count:1,chance:a.getItemAttributeValue(e["item_"+r].attributes,"bonus_chance",1)/100,displayname:e["item_"+r].displayname+" Pierce"}:i[r].count+=1;break;case"monkey_king_bar":void 0==i[r]?i[r]={item:r,chance:a.getItemAttributeValue(e["item_"+r].attributes,"bash_chance",0)/100,damage:a.getItemAttributeValue(e["item_"+r].attributes,"bash_damage",0),duration:a.getItemAttributeValue(e["item_"+r].attributes,"bash_stun",0),count:1,damageType:"magic",displayname:"Mini-Bash"}:i[r].count+=1;break;case"abyssal_blade":case"basher":i.hasOwnProperty("bash")||(i.bash={item:r,chance:a.getItemAttributeValue(e["item_"+r].attributes,"DOTA_UNIT_CAP_MELEE_ATTACK"==t?"bash_chance_melee":"bash_chance_ranged",0)/100,damage:a.getItemAttributeValue(e["item_"+r].attributes,"bonus_chance_damage",0),duration:a.getItemAttributeValue(e["item_"+r].attributes,"bash_duration",0),count:1,damageType:"physical",displayname:"Bash"})}}return i},a.getOrbProcSource=function(){for(var t={},i=0;i<a.items().length;i++){var s=a.items()[i].item;a.activeItems.indexOf(a.items()[i])>=0;if(a.items()[i].enabled())switch(s){case"maelstrom":case"mjollnir":void 0==t[s]?t[s]={chance:a.getItemAttributeValue(e["item_"+s].attributes,"chain_chance",0)/100,damage:a.getItemAttributeValue(e["item_"+s].attributes,"chain_damage",0),count:1,damageType:"magic",displayname:e["item_"+s].displayname}:t[s].count+=1}}return t},a.getOrbSource=function(){for(var t={},i=0;i<a.items().length;i++){var s=a.items()[i].item;a.activeItems.indexOf(a.items()[i])>=0;if(a.items()[i].enabled())switch(s){case"diffusal_blade":void 0==t[s]?t[s]={chance:1,damage:a.getItemAttributeValue(e["item_"+s].attributes,"feedback_mana_burn",a.items()[i].size),count:1,damageType:"physical",displayname:e["item_"+s].displayname}:t[s].count+=1}}return t},a.getHealth=function(){for(var t=0,i=0;i<a.items().length;i++){var s=a.items()[i].item;if(a.items()[i].enabled())for(var r=0;r<e["item_"+s].attributes.length;r++){var n=e["item_"+s].attributes[r];switch(n.name){case"bonus_health":t+=parseInt(n.value[0])}}}return t},a.getHealthRegen=function(){for(var t=0,i=0;i<a.items().length;i++){var s=a.items()[i].item,r=a.activeItems.indexOf(a.items()[i])>=0;if(a.items()[i].enabled())for(var n=0;n<e["item_"+s].attributes.length;n++){var m=e["item_"+s].attributes[n];switch(m.name){case"health_regen":case"bonus_regen":t+=parseInt(m.value[0]);break;case"bonus_health_regen":"tranquil_boots"!=s||r?"tranquil_boots"!=s&&(t+=parseInt(m.value[0])):t+=parseInt(m.value[0]);break;case"hp_regen":t+=parseInt(m.value[0]);break;case"health_regen_rate":"heart"==s&&r&&(t+=parseInt(m.value[0])/100*a.hero.health())}}}return t},a.getHealthRegenAura=function(t){for(var i=0,s=t||[],r=0;r<a.items().length;r++){var n=a.items()[r].item;a.activeItems.indexOf(a.items()[r])>=0;if(a.items()[r].enabled())for(var m=0;m<e["item_"+n].attributes.length;m++){var u=e["item_"+n].attributes[m];if(!(s.indexOf(n+u.name)>-1))switch(u.name){case"aura_health_regen":i+=parseInt(u.value[0]),s.push(n+u.name)}}}return{value:i,excludeList:s}},a.getMana=function(){for(var t=0,i=0;i<a.items().length;i++){var s=a.items()[i].item;if(a.items()[i].enabled())for(var r=0;r<e["item_"+s].attributes.length;r++){var n=e["item_"+s].attributes[r];switch(n.name){case"bonus_mana":t+=parseInt(n.value[0])}}}return t},a.getManaRegen=function(){for(var t=0,i=0;i<a.items().length;i++){var s=a.items()[i].item;if(a.items()[i].enabled())for(var r=0;r<e["item_"+s].attributes.length;r++){var n=e["item_"+s].attributes[r];switch(n.name){case"aura_mana_regen":case"mana_regen_aura":t+=parseFloat(n.value[0]);break;case"mana_regen":"infused_raindrop"==s&&(t+=parseFloat(n.value[0]))}}}return t},a.getManaRegenPercent=function(){for(var t=0,i=0;i<a.items().length;i++){var s=a.items()[i].item;if(a.items()[i].enabled())for(var r=0;r<e["item_"+s].attributes.length;r++){var n=e["item_"+s].attributes[r];switch(n.name){case"bonus_mana_regen":case"mana_regen":case"bonus_mana_regen_pct":"infused_raindrop"!=s&&(t+=parseFloat(n.value[0]))}}}return t/100},a.getManaRegenBloodstone=function(){for(var e=0;e<a.items().length;e++){var t=a.items()[e].item;if(a.items()[e].enabled()&&t.indexOf("bloodstone")!=-1)return parseInt(a.items()[e].size)}return 0},a.getArmor=function(){for(var t=0,i=0;i<a.items().length;i++){var s=a.items()[i].item,r=a.activeItems.indexOf(a.items()[i])>=0;if(a.items()[i].enabled())for(var n=0;n<e["item_"+s].attributes.length;n++){var m=e["item_"+s].attributes[n];switch(m.name){case"bonus_armor":(!r||"medallion_of_courage"!=s&&"solar_crest"!=s)&&(t+=parseInt(m.value[0]));break;case"unholy_bonus_armor":r&&"armlet"==s&&(t+=parseInt(m.value[0]))}}}return t},a.getArmorAura=function(t){for(var i=0,s=t||[],r=0;r<a.items().length;r++){var n=a.items()[r].item,m=a.activeItems.indexOf(a.items()[r])>=0;if(a.items()[r].enabled())for(var u=0;u<e["item_"+n].attributes.length;u++){var o=e["item_"+n].attributes[u];if(!s.find(function(e){return o.name==e.name}))switch(o.name){case"bonus_aoe_armor":m&&s.push({name:o.name,value:parseInt(o.value[0])});break;case"aura_positive_armor":s.push({name:o.name,value:parseInt(o.value[0])});break;case"aura_bonus_armor":m&&s.push({name:o.name,value:parseInt(o.value[0])});break;case"armor_aura":s.push({name:o.name,value:parseInt(o.value[0])});break;case"heal_bonus_armor":m&&s.push({name:o.name,value:parseInt(o.value[0])})}}}return s.find(function(e){return"heal_bonus_armor"==e.name})&&(s=s.filter(function(e){return"bonus_aoe_armor"!==e.name})),s.find(function(e){return"armor_aura"==e.name})&&(s=s.filter(function(e){return"aura_bonus_armor"!==e.name})),i=s.reduce(function(e,t){return e+=t.value},0),{value:i,attributes:s}},a.getArmorReduction=function(t){for(var i=0,s=t||[],r=0;r<a.items().length;r++){var n=a.items()[r].item,m=a.activeItems.indexOf(a.items()[r])>=0;if(a.items()[r].enabled())for(var u=0;u<e["item_"+n].attributes.length;u++){var o=e["item_"+n].attributes[u];if(!(s.indexOf(o.name)>-1||s.indexOf(n+"_"+o.name)>-1))switch(o.name){case"armor_reduction":(m||"medallion_of_courage"!=n&&"solar_crest"!=n)&&(i+=parseInt(o.value[0]),s.push(n+"_"+o.name));break;case"aura_negative_armor":i+=parseInt(o.value[0]),s.push(o.name);break;case"corruption_armor":i+=parseInt(o.value[0]),s.push(o.name)}}}return{value:i,excludeList:s}},a.getEvasion=function(){for(var t=1,i=0;i<a.items().length;i++){var s=a.items()[i].item,r=a.activeItems.indexOf(a.items()[i])>=0;if(a.items()[i].enabled())for(var n=0;n<e["item_"+s].attributes.length;n++){var m=e["item_"+s].attributes[n];switch(m.name){case"bonus_evasion":(!r||"butterfly"!=s&&"solar_crest"!=s)&&(t*=1-parseInt(m.value[0])/100)}}}return t},a.getMovementSpeedFlat=function(){for(var t=0,i=!1,s=!1,r=!1,n=["boots","phase_boots","arcane_boots","travel_boots","power_treads","tranquil_boots","guardian_greaves"],m=0;m<a.items().length;m++){var u=a.items()[m].item,o=a.activeItems.indexOf(a.items()[m])>=0;if(a.items()[m].enabled())for(var l=0;l<e["item_"+u].attributes.length;l++){var c=e["item_"+u].attributes[l];switch(c.name){case"bonus_movement_speed":!i&&n.indexOf(u)>=0?("tranquil_boots"!=u||"tranquil_boots"==u&&!o)&&(t+=parseInt(c.value[0]),i=!0):"cyclone"==u&&(t+=parseInt(c.value[0]),s=!0);break;case"broken_movement_speed":!i&&n.indexOf(u)>=0&&"tranquil_boots"==u&&o&&(t+=parseInt(c.value[0]),i=!0);break;case"bonus_movement":!i&&n.indexOf(u)>=0&&(t+=parseInt(c.value[0]),i=!0);break;case"movement_speed":r||"wind_lace"!=u||(t+=parseInt(c.value[0]),r=!0)}}}return t},a.getMovementSpeedPercent=function(t){for(var i=0,s=t||[],r=!1,n=!1,m=!1,u=!1,o=!1,l=!1,c=!1,v=["manta","yasha","sange_and_yasha"],_=0;_<a.items().length;_++){var b=a.items()[_].item,f=a.activeItems.indexOf(a.items()[_])>=0;if(a.items()[_].enabled())for(var d=0;d<e["item_"+b].attributes.length;d++){var p=e["item_"+b].attributes[d];if(!(s.indexOf(p.name)>-1))switch(p.name){case"movement_speed_percent_bonus":!r&&v.indexOf(b)>=0&&(i+=parseInt(p.value[0]),r=!0);break;case"bonus_aura_movement_speed_pct":n||"ancient_janggo"!=b||(i+=parseInt(p.value[0]),n=!0,s.push(p.name));break;case"phase_movement_speed":f&&!u&&(i+=parseInt(p.value[0]),u=!0);break;case"bonus_movement_speed_pct":f&&!m&&"ancient_janggo"==b&&(i+=parseInt(p.value[0]),m=!0,s.push(p.name));break;case"windwalk_movement_speed":!f||o||"invis_sword"!=b&&"silver_edge"!=b||(i+=parseInt(p.value[0]),o=!0);break;case"berserk_bonus_movement_speed":f&&!c&&"mask_of_madness"==b&&(i+=parseInt(p.value[0]),c=!0);break;case"bonus_movement_speed":r||"manta"!=b?"smoke_of_deceit"==b&&f&&(i+=parseInt(p.value[0])):(i+=parseInt(p.value[0]),r=!0);break;case"bonus_move_speed":f&&!l&&"butterfly"==b&&(i+=parseInt(p.value[0]),l=!0)}}}return{value:i/100,excludeList:s}},a.getMovementSpeedPercentReduction=function(t){for(var i=0,s=t||[],r=0;r<a.items().length;r++){var n=a.items()[r].item,m=a.activeItems.indexOf(a.items()[r])>=0;if(a.items()[r].enabled())for(var u=0;u<e["item_"+n].attributes.length;u++){var o=e["item_"+n].attributes[u];if(!(s.indexOf(o.name)>-1))switch(o.name){case"movespeed":"dust"==n&&m&&(i+=parseInt(o.value[0]));case"blast_movement_speed":"shivas_guard"==n&&m&&(i+=parseInt(o.value[0]),s.push(o.name));case"cold_movement_speed":"skadi"==n&&(i+=parseInt(o.value[0]));break;case"maim_movement_speed":a.items()[r].debuff&&"maim"==a.items()[r].debuff&&(i+=parseInt(o.value[0]),s.push(o.name))}}}return{value:i/100,excludeList:s}},a.getBonusDamage=function(){for(var t=0,i={},s=0;s<a.items().length;s++){var r=a.items()[s].item,n=a.activeItems.indexOf(a.items()[s])>=0;if(a.items()[s].enabled())for(var m=0;m<e["item_"+r].attributes.length;m++){var u=e["item_"+r].attributes[m];switch(u.name){case"bonus_damage":t+=parseInt(u.value[0]),void 0==i[r]?i[r]={damage:parseInt(u.value[0]),damageType:"physical",count:1,displayname:e["item_"+r].displayname}:i[r].count+=1;break;case"unholy_bonus_damage":n&&(t+=parseInt(u.value[0]),void 0==i[r+"_active"]?i[r+"_active"]={damage:parseInt(u.value[0]),damageType:"physical",count:1,displayname:e["item_"+r].displayname+" Unholy Strength"}:i[r].count+=1)}}}return{sources:i,total:t}},a.getBonusDamagePercent=function(t){t=t||{sources:{},total:0};for(var i=t.total||0,s=t.sources||{},r=0;r<a.items().length;r++){var n=a.items()[r].item;a.activeItems.indexOf(a.items()[r])>=0;if(a.items()[r].enabled())for(var m=0;m<e["item_"+n].attributes.length;m++){var u=e["item_"+n].attributes[m];switch(u.name){case"damage_aura":void 0==s[n]&&(i+=parseInt(u.value[0])/100,s[n]={damage:parseInt(u.value[0])/100,damageType:"physical",count:1,displayname:e["item_"+n].displayname})}}}return{sources:s,total:i}},a.getAttackSpeed=function(t){for(var i=0,s=!1,r=t||[],n=0;n<a.items().length;n++){var m=a.items()[n].item,u=a.activeItems.indexOf(a.items()[n])>=0;if(a.items()[n].enabled())for(var o=0;o<e["item_"+m].attributes.length;o++){var l=e["item_"+m].attributes[o];if(!(r.indexOf(l.name)>-1))switch(l.name){case"bonus_attack_speed":"power_treads"==m?s||(i+=parseInt(l.value[0]),s=!0):"moon_shard"==m?u||(i+=parseInt(l.value[0])):"hurricane_pike"==m?u&&(i+=parseInt(l.value[0])):i+=parseInt(l.value[0]);break;case"consumed_bonus":"moon_shard"==m&&u&&(i+=parseInt(l.value[0]));break;case"bonus_speed":i+=parseInt(l.value[0]);break;case"aura_attack_speed":"shivas_guard"!=m&&(i+=parseInt(l.value[0]));break;case"bonus_aura_attack_speed_pct":i+=parseInt(l.value[0]),r.push(l.name);break;case"bonus_attack_speed_pct":u&&(i+=parseInt(l.value[0]),r.push(l.name));break;case"unholy_bonus_attack_speed":u&&(i+=parseInt(l.value[0]));break;case"berserk_bonus_attack_speed":u&&(i+=parseInt(l.value[0]))}}}return{value:i,excludeList:r}},a.getAttackSpeedReduction=function(t){for(var i=0,s=t||[],r=0;r<a.items().length;r++){var n=a.items()[r].item;a.activeItems.indexOf(a.items()[r])>=0;if(a.items()[r].enabled())for(var m=0;m<e["item_"+n].attributes.length;m++){var u=e["item_"+n].attributes[m];if(!(s.indexOf(u.name)>-1))switch(u.name){case"aura_attack_speed":"shivas_guard"==n&&(i+=parseInt(u.value[0]),s.push(u.name));break;case"cold_attack_speed":"skadi"==n&&(i+=parseInt(u.value[0]),s.push(u.name));break;case"maim_attack_speed":a.items()[r].debuff&&"maim"==a.items()[r].debuff&&(i+=parseInt(u.value[0]),s.push(u.name))}}}return{value:i,excludeList:s}},a.getLifesteal=function(){for(var t=0,i=0;i<a.items().length;i++){var s=a.items()[i].item,r=a.activeItems.indexOf(a.items()[i])>=0;if(a.items()[i].enabled())for(var n=0;n<e["item_"+s].attributes.length;n++){var m=e["item_"+s].attributes[n];switch(m.name){case"lifesteal_percent":if("satanic"!=s)return parseInt(m.value[0]);if(!r)return parseInt(m.value[0]);break;case"unholy_lifesteal_percent":if(r)return parseInt(m.value[0])}}}return t},a.getLifestealAura=function(t){for(var i=0,s=t||[],r=0;r<a.items().length;r++){var n=a.items()[r].item;a.activeItems.indexOf(a.items()[r])>=0;if(a.items()[r].enabled())for(var m=0;m<e["item_"+n].attributes.length;m++){var u=e["item_"+n].attributes[m];if(!(s.indexOf(u.name)>-1))switch(u.name){case"vampiric_aura":i+=parseInt(u.value[0]),s.push(u.name)}}}return{value:i,excludeList:s}},a.getSpellAmp=ko.computed(function(){for(var t=0,i=0;i<a.items().length;i++){var s=a.items()[i].item;a.activeItems.indexOf(a.items()[i])>=0;if(a.items()[i].enabled())for(var r=0;r<e["item_"+s].attributes.length;r++){var n=e["item_"+s].attributes[r];switch(n.name){case"spell_amp":t+=parseInt(n.value[0])}}}return t}),a.getCooldownReductionFlat=ko.computed(function(){var e=0;return e}),a.getCooldownReductionPercent=function(t){for(var i=1,s=t||[],r=0;r<a.items().length;r++){var n=a.items()[r].item;a.activeItems.indexOf(a.items()[r])>=0;if(a.items()[r].enabled())for(var m=0;m<e["item_"+n].attributes.length;m++){var u=e["item_"+n].attributes[m];if(!s.find(function(e){return u.name==e.name}))switch(u.name){case"bonus_cooldown":s.push({name:u.name,value:parseInt(u.value[0])})}}}return i=s.reduce(function(e,t){return e*=1-t.value/100},1),{value:i,attributes:s}},a.getCooldownIncreaseFlat=ko.computed(function(){var e=0;return e}),a.getCooldownIncreasePercent=function(){var e=1;return e},a.getMagicResist=function(){for(var t=1,i=0;i<a.items().length;i++){var s=a.items()[i].item;a.activeItems.indexOf(a.items()[i])>=0;if(a.items()[i].enabled())for(var r=0;r<e["item_"+s].attributes.length;r++){var n=e["item_"+s].attributes[r];switch(n.name){case"bonus_magical_armor":t*=1-parseInt(n.value[0])/100;break;case"bonus_spell_resist":t*=1-parseInt(n.value[0])/100;break;case"magic_resistance":t*=1-parseInt(n.value[0])/100}}}return t},a.getMagicResistReductionSelf=function(){for(var t=1,i=0;i<a.items().length;i++){var s=a.items()[i].item,r=a.activeItems.indexOf(a.items()[i])>=0;if(a.items()[i].enabled()&&r)for(var n=0;n<e["item_"+s].attributes.length;n++){var m=e["item_"+s].attributes[n];switch(m.name){case"extra_spell_damage_percent":case"ethereal_damage_bonus":return 1-parseInt(m.value[0])/100}}}return t},a.getMagicResistReduction=function(){for(var t=1,i=0;i<a.items().length;i++){var s=a.items()[i].item,r=a.activeItems.indexOf(a.items()[i])>=0;if(a.items()[i].enabled()&&r)for(var n=0;n<e["item_"+s].attributes.length;n++){var m=e["item_"+s].attributes[n];switch(m.name){case"ethereal_damage_bonus":a.isEthereal()||(t*=1-parseInt(m.value[0])/100);case"resist_debuff":t*=1-parseInt(m.value[0])/100}}}return t},a.getVisionRangeNight=ko.computed(function(){for(var t=0,i=0;i<a.items().length;i++){var s=a.items()[i].item,r=a.activeItems.indexOf(a.items()[i])>=0;if(a.items()[i].enabled())for(var n=0;n<e["item_"+s].attributes.length;n++){var m=e["item_"+s].attributes[n];switch(m.name){case"bonus_night_vision":"moon_shard"==s&&r||(t+=parseInt(m.value[0]))}}}return t}),a.getAttackRange=function(t,i){for(var s=0,r=i||[],n=0;n<a.items().length;n++){var m=a.items()[n].item;a.activeItems.indexOf(a.items()[n])>=0;if(a.items()[n].enabled())for(var u=0;u<e["item_"+m].attributes.length;u++){var o=e["item_"+m].attributes[u];if(!r.find(function(e){return o.name==e.name}))switch(o.name){case"base_attack_range":"DOTA_UNIT_CAP_RANGED_ATTACK"==t&&r.push({name:o.name,value:parseInt(o.value[0])})}}}return s=r.reduce(function(e,t){return e+=t.value},0),{value:s,attributes:r}},a.getMissChance=function(t){for(var i=1,s=t||[],r=0;r<a.items().length;r++){var n=a.items()[r].item,m=a.activeItems.indexOf(a.items()[r])>=0;if(a.items()[r].enabled())for(var u=0;u<e["item_"+n].attributes.length;u++){var o=e["item_"+n].attributes[u];if(!(s.indexOf(o.name)>-1))switch(o.name){case"miss_chance":"solar_crest"===n&&m&&(i*=1-parseInt(o.value[0])/100,s.push(o.name));break;case"blind_pct":i*=1-parseInt(o.value[0])/100,s.push(o.name)}}}return{value:i,excludeList:s}},a.getBaseDamageReductionPct=function(){for(var t=1,i=0;i<a.items().length;i++){var s=a.items()[i].item;a.activeItems.indexOf(a.items()[i])>=0;if(a.items()[i].enabled())for(var r=0;r<e["item_"+s].attributes.length;r++){var n=e["item_"+s].attributes[r];switch(n.name){case"backstab_reduction":a.items()[i].debuff&&"shadow_walk"==a.items()[i].debuff&&(t*=1+parseInt(n.value[0])/100)}}}return t},a.getBonusDamageReductionPct=function(){for(var t=1,i=0;i<a.items().length;i++){var s=a.items()[i].item;a.activeItems.indexOf(a.items()[i])>=0;if(a.items()[i].enabled())for(var r=0;r<e["item_"+s].attributes.length;r++){var n=e["item_"+s].attributes[r];switch(n.name){case"backstab_reduction":a.items()[i].debuff&&"shadow_walk"==a.items()[i].debuff&&(t*=1+parseInt(n.value[0])/100)}}}return t},a.itemOptions=ko.observableArray(itemOptionsArray.items),a.itemBuffOptions=ko.observableArray(itemBuffOptions.items),a.selectedItemBuff=ko.observable("assault"),a.itemDebuffOptions=ko.observableArray(itemDebuffOptions.items),a.selectedItemDebuff=ko.observable("assault"),a};InventoryViewModel.prototype=Object.create(BasicInventoryViewModel.prototype),InventoryViewModel.prototype.constructor=InventoryViewModel,module.exports=InventoryViewModel;
