...
(function (global){
require("./app/polyfill");var Rollbar=require("rollbar-browser"),$="undefined"!=typeof window?window.$:"undefined"!=typeof global?global.$:null,getParameterByName=require("./app/getParameterByName"),HeroCalc=require("dota-hero-calculator-library"),App=function(e){function r(e){l.length>10&&l.shift(),l.push(e)}function a(e,a){return function(){var t=this,o={eventName:a};t.id&&(o.id=t.id),t.src&&(o.src=t.src),t.className&&(o.className=t.className),t.textContent&&(o.textContent=t.textContent),t.nodeName&&(o.nodeName=t.nodeName),t.getAttribute("data-bind")&&(o["data-bind"]=t.getAttribute("data-bind"));for(var n in o)o.hasOwnProperty(n)&&(o[n]=o[n].substring(0,Math.min(200,o[n].length)));return r(o),e.apply(this,arguments)}}function t(e,r,a,t,o){var n=e[r];return e[r]=function(){return o.indexOf(arguments[0])!=-1&&(arguments[a]=t(arguments[a],arguments[0])),n.apply(this,arguments)},n}HeroCalc.init(null,null,null,function(){var r=require("./app/HeroCalculatorViewModel"),a=new r(e.abilityTooltipPath);ko.options.deferUpdates=!0,ko.applyBindings(a),$("#spinner").hide(),$(".initial-hidden").css("display","inline-block"),$("#popHero0").addClass("active"),$("#heroPane0").addClass("active"),$('[data-toggle="tooltip"]').tooltip();var t=getParameterByName("id");t&&$.get("save/"+t+".json",function(e){a.load(e)})});var o="Mon Dec 12 2016 11:40:05 GMT-0500 (EST)";$("#last-update").text(o);var n={accessToken:"de1980fcab4849d6a7a066cf098a6521",captureUncaught:!0,payload:{environment:"production",client:{javascript:{source_map_enabled:!0,code_version:"6ed0ab20be294a9b9d6916b829e67a09802356a4",guess_uncaught_frames:!0}}}},i=Rollbar.init(n);$(".error-warning-view, .error-warning-close").click(function(){$(".error-warning").fadeOut(200)});var l=[];t(Element.prototype,"addEventListener",1,a,["click","focus","blur","change","dblclick"]),window.onerror=function(e){return function(){var r={},a=document.querySelector("#log");if(a)try{var t=arguments[0],o=document.createElement("div");o.classList.add("alert"),o.classList.add("alert-danger"),o.classList.add("error-log"),o.classList.add("col-md-12"),o.textContent="error: "+t;var n=document.createElement("div");n.classList.add("error-log-close"),n.innerHTML="&times;",n.onclick=function(){a.removeChild(o)},o.appendChild(n);var d=document.createElement("a");d.classList.add("error-log-link"),d.innerHTML="Send error report",d.href="#",d.onclick=function(){$("#myModal").modal("show"),$("#BugReportFormText").text("error: "+t+"\n\nDescribe what you were doing. Try to be as detailed as possible.")},o.appendChild(d),a.appendChild(o),$(".error-warning").fadeOut(200).fadeIn(100)}catch(e){i.error("window.onerror create error log failed.",e)}else r.clientLogCreated=!1;if(HeroCalculatorViewModel&&viewModel){try{r.heroCalcState=viewModel.getSaveData()}catch(e){i.error("window.onerror getSaveData failed.",e)}try{r.appState=viewModel.getAppState()}catch(e){i.error("window.onerror getAppState failed.",e)}}else r.appState="load failed";return r.userActions=l,i.configure({payload:{custom:r}}),e.apply(this,arguments)}}(window.onerror)};module.exports=App;
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
