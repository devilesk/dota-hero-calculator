...
var HeroCalcData={heroData:{},itemData:{},unitData:{}};module.exports=HeroCalcData;
},{}],7:[function(require,module,exports){
var HeroCalcData=require("./HeroCalcData")||{},getJSON=require("../util/getJSON"),isEmpty=require("../util/isEmpty"),isString=require("../util/isString"),extend=function(e){e=e||{};for(var a=1;a<arguments.length;a++)if(arguments[a])for(var o in arguments[a])arguments[a].hasOwnProperty(o)&&(e[o]=arguments[a][o]);return e},resourceCounter=0,onResourceLoaded=function(e){resourceCounter--,0===resourceCounter&&(fixHeroData(HeroCalcData.heroData),modifyItemData(HeroCalcData.itemData),e&&e())},modifyItemData=function(e){e.item_bottle_doubledamage={displayname:"Double Damage",name:"item_bottle_doubledamage",attributes:[{name:"bottle_doubledamage",tooltip:"%BONUS ATTACK DAMAGE:",value:[100]}]}},fixHeroData=function(e){e.npc_dota_hero_invoker.abilities[5].behavior.push("DOTA_ABILITY_BEHAVIOR_NOT_LEARNABLE"),e.npc_dota_hero_chen.abilities[2].behavior.push("DOTA_ABILITY_BEHAVIOR_NOT_LEARNABLE"),e.npc_dota_hero_nevermore.abilities[1].behavior.push("DOTA_ABILITY_BEHAVIOR_NOT_LEARNABLE"),e.npc_dota_hero_nevermore.abilities[2].behavior.push("DOTA_ABILITY_BEHAVIOR_NOT_LEARNABLE"),e.npc_dota_hero_morphling.abilities[3].behavior.push("DOTA_ABILITY_BEHAVIOR_NOT_LEARNABLE"),e.npc_dota_hero_ogre_magi.abilities[3].behavior.push("DOTA_ABILITY_BEHAVIOR_NOT_LEARNABLE"),e.npc_dota_hero_techies.abilities[4].behavior.push("DOTA_ABILITY_BEHAVIOR_NOT_LEARNABLE"),e.npc_dota_hero_beastmaster.abilities[2].behavior.push("DOTA_ABILITY_BEHAVIOR_NOT_LEARNABLE");var a=e.npc_dota_hero_lone_druid.abilities[3].behavior.indexOf("DOTA_ABILITY_BEHAVIOR_HIDDEN");e.npc_dota_hero_lone_druid.abilities[3].behavior.splice(a,1),a=e.npc_dota_hero_abaddon.abilities[2].behavior.indexOf("DOTA_ABILITY_BEHAVIOR_PASSIVE"),e.npc_dota_hero_abaddon.abilities[2].behavior.splice(a,1),a=e.npc_dota_hero_riki.abilities[2].behavior.indexOf("DOTA_ABILITY_BEHAVIOR_PASSIVE"),e.npc_dota_hero_riki.abilities[2].behavior.splice(a,1)},init=function(e,a,o,t){resourceCounter=3,!HeroCalcData.heroData||isEmpty(HeroCalcData.heroData)?isString(e)?getJSON(e,function(e){HeroCalcData.heroData=e,onResourceLoaded(t)}):isEmpty(e)||(HeroCalcData.heroData=e,onResourceLoaded(t)):onResourceLoaded(t),!HeroCalcData.itemData||isEmpty(HeroCalcData.itemData)?isString(a)?getJSON(a,function(e){HeroCalcData.itemData=e,onResourceLoaded(t)}):isEmpty(a)||(HeroCalcData.itemData=a,onResourceLoaded(t)):onResourceLoaded(t),!HeroCalcData.unitData||isEmpty(HeroCalcData.unitData)?isString(o)?getJSON(o,function(e){HeroCalcData.unitData=e,onResourceLoaded(t)}):isEmpty(o)||(HeroCalcData.unitData=o,onResourceLoaded(t)):onResourceLoaded(t)};HeroCalcData.init=init,module.exports=HeroCalcData;
...
"use strict";var ko=require("../herocalc_knockout"),AbilityModel=require("../AbilityModel"),BuffViewModel=require("../BuffViewModel"),InventoryViewModel=require("../inventory/InventoryViewModel"),diffProperties=require("./diffProperties"),HeroDamageMixin=require("./HeroDamageMixin"),TalentController=require("./TalentController"),totalExp=require("./totalExp"),nextLevelExp=require("./nextLevelExp"),HeroModel=function(e,t,a){var n=this;n.heroId=ko.observable(a),n.selectedHeroLevel=ko.observable(1),n.inventory=new InventoryViewModel(t,n),n.selectedInventory=ko.observable(-1),n.buffs=new BuffViewModel(t),n.buffs.hasScepter=n.inventory.hasScepter,n.debuffs=new BuffViewModel(t),n.heroData=ko.computed(function(){return e["npc_dota_hero_"+n.heroId()]}),n.heroCompare=ko.observable(n),n.enemy=ko.observable(n),n.unit=ko.observable(n),n.clone=ko.observable(n),n.talents=[ko.observable(-1),ko.observable(-1),ko.observable(-1),ko.observable(-1)],n.selectedTalents=ko.computed(function(){for(var e=[],t=0;t<4;t++)n.talents[t]()!==-1&&e.push(n.heroData().talents[t][n.talents[t]()]);return e}),n.skillPointHistory=ko.observableArray(),n.ability=ko.computed(function(){var e=new AbilityModel(ko.observableArray(JSON.parse(JSON.stringify(n.heroData().abilities))),n);switch(n.heroId()){case"earth_spirit":case"ogre_magi":e._abilities[3].level(1);break;case"monkey_king":e._abilities[5].level(1);break;case"invoker":for(var t=5;t<16;t++)e._abilities[t].level(1)}return n.skillPointHistory.removeAll(),e.hasScepter=n.inventory.hasScepter,e}),n.availableSkillPoints=ko.computed(function(){for(var e=n.selectedHeroLevel(),t=0;t<4;t++)n.selectedHeroLevel()<5*t+10&&n.talents[t](-1);e-=n.talents.filter(function(e){return e()!==-1}).length;for(var t=0;t<n.ability().abilities().length;t++)switch(n.ability().abilities()[t].abilitytype){case"DOTA_ABILITY_TYPE_ULTIMATE":if("invoker"===n.heroId());else if("meepo"===n.heroId())for(;7*(n.ability().abilities()[t].level()-1)+3>parseInt(n.selectedHeroLevel());)n.ability().levelDownAbility(t,null,null,n);else for(;5*n.ability().abilities()[t].level()+1>parseInt(n.selectedHeroLevel());)n.ability().levelDownAbility(t,null,null,n);break;default:for(;2*n.ability().abilities()[t].level()-1>parseInt(n.selectedHeroLevel());)n.ability().levelDownAbility(t,null,null,n)}for(;n.skillPointHistory().length>e;)n.ability().levelDownAbility(n.skillPointHistory()[n.skillPointHistory().length-1],null,null,n);return e-n.skillPointHistory().length},this),n.primaryAttribute=ko.pureComputed(function(){var e=n.heroData().attributeprimary;return"DOTA_ATTRIBUTE_AGILITY"===e?"agi":"DOTA_ATTRIBUTE_INTELLECT"===e?"int":"DOTA_ATTRIBUTE_STRENGTH"===e?"str":""}),n.totalExp=ko.pureComputed(function(){return totalExp[n.selectedHeroLevel()-1]}),n.nextLevelExp=ko.pureComputed(function(){return nextLevelExp[n.selectedHeroLevel()-1]}),n.startingArmor=ko.pureComputed(function(){return(.14*n.heroData().attributebaseagility+n.heroData().armorphysical).toFixed(2)}),n.respawnTime=ko.pureComputed(function(){var e=n.selectedHeroLevel(),t=TalentController.getRespawnReduction(n.selectedTalents());return e>=1&&e<=5?2*(e-1)+8-t:e>=6&&e<=11?2*(e-6)+26-t:e>=12&&e<=17?2*(e-12)+46-t:e>=18&&e<=24?4*(e-18)+66-t:25==e?100-t:void 0}),n.totalAttribute=function(e){return"agi"===e?parseFloat(n.totalAgi()):"int"===e?parseFloat(n.totalInt()):"str"===e?parseFloat(n.totalStr()):0},n.totalAgi=ko.pureComputed(function(){return(n.heroData().attributebaseagility+n.heroData().attributeagilitygain*(n.selectedHeroLevel()-1)+n.inventory.getAttributes("agi")+2*n.ability().getAttributeBonusLevel()+n.ability().getAgility()+TalentController.getAgility(n.selectedTalents())+n.enemy().ability().getAllStatsReduction()+n.debuffs.getAllStatsReduction()).toFixed(2)}),n.intStolen=ko.observable(0).extend({numeric:0}),n.totalInt=ko.pureComputed(function(){return(n.heroData().attributebaseintelligence+n.heroData().attributeintelligencegain*(n.selectedHeroLevel()-1)+n.inventory.getAttributes("int")+2*n.ability().getAttributeBonusLevel()+n.ability().getIntelligence()+TalentController.getIntelligence(n.selectedTalents())+n.enemy().ability().getAllStatsReduction()+n.debuffs.getAllStatsReduction()+n.intStolen()).toFixed(2)}),n.totalStr=ko.pureComputed(function(){return(n.heroData().attributebasestrength+n.heroData().attributestrengthgain*(n.selectedHeroLevel()-1)+n.inventory.getAttributes("str")+2*n.ability().getAttributeBonusLevel()+n.ability().getStrength()+TalentController.getStrength(n.selectedTalents())+n.enemy().ability().getStrengthReduction()+n.enemy().ability().getAllStatsReduction()+n.debuffs.getAllStatsReduction()).toFixed(2)}),n.health=ko.pureComputed(function(){return(n.heroData().statushealth+20*Math.floor(n.totalStr())+n.inventory.getHealth()+n.ability().getHealth()+TalentController.getHealth(n.selectedTalents())).toFixed(2)}),n.healthregen=ko.pureComputed(function(){var e=[n.inventory.getHealthRegenAura,n.buffs.itemBuffs.getHealthRegenAura].reduce(function(e,t){var a=t(e.excludeList);return a.value+=e.value,a},{value:0,excludeList:[]});return(n.heroData().statushealthregen+.03*n.totalStr()+n.inventory.getHealthRegen()+n.ability().getHealthRegen()+TalentController.getHealthRegen(n.selectedTalents())+n.buffs.getHealthRegen()+e.value).toFixed(2)}),n.mana=ko.pureComputed(function(){return(n.heroData().statusmana+12*n.totalInt()+n.inventory.getMana()+TalentController.getMana(n.selectedTalents())+n.ability().getMana()).toFixed(2)}),n.manaregen=ko.pureComputed(function(){return((n.heroData().statusmanaregen+.04*n.totalInt()+n.ability().getManaRegen()+TalentController.getManaRegen(n.selectedTalents()))*(1+n.inventory.getManaRegenPercent())+("crystal_maiden"===n.heroId()?2*n.ability().getManaRegenArcaneAura():n.buffs.getManaRegenArcaneAura())+n.inventory.getManaRegenBloodstone()+n.inventory.getManaRegen()-n.enemy().ability().getManaRegenReduction()).toFixed(2)}),n.totalArmorPhysical=ko.pureComputed(function(){var e=[n.inventory.getArmorAura,n.buffs.itemBuffs.getArmorAura].reduce(function(e,t){var a=t(e.attributes);return a},{value:0,attributes:[]}),t=[n.enemy().inventory.getArmorReduction,n.debuffs.itemBuffs.getArmorReduction].reduce(function(e,t){var a=t(e.excludeList);return a.value+=e.value,a},{value:0,excludeList:[]});return(n.enemy().ability().getArmorBaseReduction()*n.debuffs.getArmorBaseReduction()*(n.heroData().armorphysical+.14*n.totalAgi())+n.inventory.getArmor()+n.ability().getArmor()+TalentController.getArmor(n.selectedTalents())+n.enemy().ability().getArmorReduction()+n.buffs.getArmor()+n.buffs.itemBuffs.getArmor()+n.debuffs.getArmorReduction()+e.value+t.value).toFixed(2)}),n.totalArmorPhysicalReduction=ko.pureComputed(function(){var e=n.totalArmorPhysical();return e>=0?(.06*n.totalArmorPhysical()/(1+.06*n.totalArmorPhysical())*100).toFixed(2):-(.06*-n.totalArmorPhysical()/(1+.06*-n.totalArmorPhysical())*100).toFixed(2)}),n.spellAmp=ko.pureComputed(function(){return(n.totalInt()/16+n.inventory.getSpellAmp()+n.ability().getSpellAmp()+TalentController.getSpellAmp(n.selectedTalents())+n.buffs.getSpellAmp()).toFixed(2)}),n.cooldownReductionFlat=ko.pureComputed(function(){return n.inventory.getCooldownReductionFlat()+n.ability().getCooldownReductionFlat()+TalentController.getCooldownReductionFlat(n.selectedTalents())+n.buffs.getCooldownReductionFlat()-n.enemy().inventory.getCooldownIncreaseFlat()-n.enemy().ability().getCooldownIncreaseFlat()-n.debuffs.getCooldownIncreaseFlat()-n.debuffs.itemBuffs.getCooldownIncreaseFlat()}),n.cooldownReductionProduct=ko.pureComputed(function(){return n.inventory.getCooldownReductionPercent().value*n.ability().getCooldownReductionPercent()*TalentController.getCooldownReductionPercent(n.selectedTalents())*n.buffs.getCooldownReductionPercent()*n.enemy().inventory.getCooldownIncreasePercent()*n.enemy().ability().getCooldownIncreasePercent()*n.debuffs.getCooldownIncreasePercent()*n.debuffs.itemBuffs.getCooldownIncreasePercent()}),n.cooldownReductionPercent=ko.pureComputed(function(){return(100*(1-n.cooldownReductionProduct())).toFixed(2)}),n.totalMovementSpeed=ko.pureComputed(function(){var e=100,t=n.ability().setMovementSpeed()>0?n.ability().setMovementSpeed():n.buffs.setMovementSpeed();if(t>0)return t;var a=[n.inventory.getMovementSpeedPercent,n.buffs.itemBuffs.getMovementSpeedPercent].reduce(function(e,t){var a=t(e.excludeList);return a.value+=e.value,a},{value:0,excludeList:[]}),o=[n.enemy().inventory.getMovementSpeedPercentReduction,n.debuffs.itemBuffs.getMovementSpeedPercentReduction].reduce(function(e,t){var a=t(e.excludeList);return a.value+=e.value,a},{value:0,excludeList:[]});return Math.max(n.enemy().inventory.isSheeped()||n.debuffs.itemBuffs.isSheeped()?140:(n.heroData().movementspeed+n.inventory.getMovementSpeedFlat()+n.ability().getMovementSpeedFlat()+TalentController.getMovementSpeedFlat(n.selectedTalents()))*(1+a.value+o.value+n.ability().getMovementSpeedPercent()+n.enemy().ability().getMovementSpeedPercentReduction()+n.buffs.getMovementSpeedPercent()+n.debuffs.getMovementSpeedPercentReduction()+n.unit().ability().getMovementSpeedPercent()),e).toFixed(2)}),n.totalTurnRate=ko.pureComputed(function(){return(n.heroData().movementturnrate*(1+n.enemy().ability().getTurnRateReduction()+n.debuffs.getTurnRateReduction())).toFixed(2)}),n.baseDamage=ko.pureComputed(function(){var e=n.totalAttribute(n.primaryAttribute()),t=n.ability().getBaseDamage(),a=n.heroData().attackdamagemin,o=n.heroData().attackdamagemax;return[Math.floor((a+e+t.total)*n.ability().getSelfBaseDamageReductionPct()*n.enemy().ability().getBaseDamageReductionPct()*n.debuffs.getBaseDamageReductionPct()*n.debuffs.itemBuffs.getBaseDamageReductionPct()*t.multiplier),Math.floor((o+e+t.total)*n.ability().getSelfBaseDamageReductionPct()*n.enemy().ability().getBaseDamageReductionPct()*n.debuffs.getBaseDamageReductionPct()*n.debuffs.itemBuffs.getBaseDamageReductionPct()*t.multiplier)]}),n.baseDamageAvg=ko.pureComputed(function(){return(n.baseDamage()[0]+n.baseDamage()[1])/2}),n.baseDamageMin=ko.pureComputed(function(){return n.baseDamage()[0]}),n.baseDamageMax=ko.pureComputed(function(){return n.baseDamage()[1]}),n.bonusDamage=ko.pureComputed(function(){return(n.inventory.getBonusDamage().total+n.ability().getBonusDamage().total+TalentController.getBonusDamage(n.selectedTalents()).total+n.buffs.getBonusDamage().total+Math.floor((n.baseDamage()[0]+n.baseDamage()[1])/2*(n.buffs.itemBuffs.getBonusDamagePercent(n.inventory.getBonusDamagePercent()).total+n.ability().getBonusDamagePercent().total+n.buffs.getBonusDamagePercent().total))+Math.floor("DOTA_UNIT_CAP_RANGED_ATTACK"==n.heroData().attacktype?"drow_ranger"==n.heroId()?n.ability().getBonusDamagePrecisionAura().total[0]*n.totalAgi():n.buffs.getBonusDamagePrecisionAura().total[1]:0)+Math.floor("riki"==n.heroId()?n.ability().getBonusDamageBackstab().total[0]*n.totalAgi():0))*n.ability().getSelfBaseDamageReductionPct()*n.enemy().ability().getBaseDamageReductionPct()*n.debuffs.itemBuffs.getBaseDamageReductionPct()}),n.bonusDamageReduction=ko.pureComputed(function(){return Math.abs(n.enemy().ability().getBonusDamageReduction()+n.debuffs.getBonusDamageReduction())}),n.damageAvg=ko.pureComputed(function(){return(n.baseDamage()[0]+n.baseDamage()[1])/2+n.bonusDamage()}),n.damageMin=ko.pureComputed(function(){return n.baseDamage()[0]+n.bonusDamage()}),n.damageMax=ko.pureComputed(function(){return n.baseDamage()[1]+n.bonusDamage()}),n.damage=ko.pureComputed(function(){return[n.baseDamage()[0]+n.bonusDamage(),n.baseDamage()[1]+n.bonusDamage()]}),n.totalMagicResistanceProduct=ko.pureComputed(function(){return(1-n.heroData().magicalresistance/100)*n.inventory.getMagicResist()*n.ability().getMagicResist()*TalentController.getMagicResist(n.selectedTalents())*n.buffs.getMagicResist()*n.inventory.getMagicResistReductionSelf()*n.enemy().inventory.getMagicResistReduction()*n.enemy().ability().getMagicResistReduction()*n.debuffs.getMagicResistReduction()*n.debuffs.itemBuffs.getMagicResistReduction()}),n.totalMagicResistance=ko.pureComputed(function(){return(100*(1-n.totalMagicResistanceProduct())).toFixed(2)}),n.bat=ko.pureComputed(function(){var e=n.ability().getBAT();return e>0?e:n.heroData().attackrate}),n.ias=ko.pureComputed(function(){var e=[n.inventory.getAttackSpeed,n.buffs.itemBuffs.getAttackSpeed].reduce(function(e,t){var a=t(e.excludeList);return a.value+=e.value,a},{value:0,excludeList:[]}),t=[n.enemy().inventory.getAttackSpeedReduction,n.debuffs.itemBuffs.getAttackSpeedReduction].reduce(function(e,t){var a=t(e.excludeList);return a.value+=e.value,a},{value:0,excludeList:[]}),a=parseFloat(n.totalAgi())+e.value+t.value+n.ability().getAttackSpeed()+TalentController.getAttackSpeed(n.selectedTalents())+n.enemy().ability().getAttackSpeedReduction()+n.buffs.getAttackSpeed()+n.debuffs.getAttackSpeedReduction()+n.unit().ability().getAttackSpeed();return a<-80?-80:a>500?500:a.toFixed(2)}),n.attackTime=ko.pureComputed(function(){return(n.bat()/(1+n.ias()/100)).toFixed(2)}),n.attacksPerSecond=ko.pureComputed(function(){return((1+n.ias()/100)/n.bat()).toFixed(2)}),n.evasion=ko.pureComputed(function(){if(n.enemy().inventory.isSheeped()||n.debuffs.itemBuffs.isSheeped())return 0;var e=n.ability().setEvasion();return e?(100*e).toFixed(2):(100*(1-n.inventory.getEvasion()*n.ability().getEvasion()*n.ability().getEvasionBacktrack()*TalentController.getEvasion(n.selectedTalents())*n.buffs.itemBuffs.getEvasion())).toFixed(2)}),n.ehpPhysical=ko.pureComputed(function(){var e=n.enemy().inventory.isSheeped()||n.debuffs.itemBuffs.isSheeped()?1:n.inventory.getEvasion()*n.ability().getEvasion()*n.buffs.itemBuffs.getEvasion();if(n.totalArmorPhysical()>=0)var t=n.health()*(1+.06*n.totalArmorPhysical());else var t=n.health()*(1-.06*n.totalArmorPhysical())/(1-.12*n.totalArmorPhysical());return t/=1-(1-e*n.ability().getEvasionBacktrack()),t/=1-parseFloat(n.enemy().missChance())/100,t*=n.inventory.activeItems().some(function(e){return"mask_of_madness"==e.item})?1/1.3:1,t*=1/n.ability().getDamageReduction(),t*=1/n.buffs.getDamageReduction(),t*=1/n.enemy().ability().getDamageAmplification(),t*=1/n.debuffs.getDamageAmplification(),t.toFixed(2)}),n.ehpMagical=ko.pureComputed(function(){var e=n.health()/n.totalMagicResistanceProduct();return e*=n.inventory.activeItems().some(function(e){return"mask_of_madness"==e.item})?1/1.3:1,e*=1/n.ability().getDamageReduction(),e*=1/n.buffs.getDamageReduction(),e*=1/n.ability().getEvasionBacktrack(),e*=1/n.enemy().ability().getDamageAmplification(),e*=1/n.debuffs.getDamageAmplification(),e.toFixed(2)}),n.bash=ko.pureComputed(function(){var e=n.heroData().attacktype;return(100*(1-n.inventory.getBash(e)*n.ability().getBash())).toFixed(2)}),n.critChance=ko.pureComputed(function(){return(100*(1-n.inventory.getCritChance()*n.ability().getCritChance())).toFixed(2)}),HeroDamageMixin(n,t),n.missChance=ko.pureComputed(function(){var e=[n.enemy().inventory.getMissChance,n.debuffs.itemBuffs.getMissChance].reduce(function(e,t){var a=t(e.excludeList);return a.value*=e.value,a},{value:1,excludeList:[]});return(100*(1-n.enemy().ability().getMissChance()*n.debuffs.getMissChance()*e.value)).toFixed(2)}),n.totalattackrange=ko.pureComputed(function(){var e=n.heroData().attacktype;return n.heroData().attackrange+n.ability().getAttackRange()+TalentController.getAttackRange(n.selectedTalents())+n.inventory.getAttackRange(e).value}),n.visionrangeday=ko.pureComputed(function(){return n.heroData().visiondaytimerange*(1+n.enemy().ability().getVisionRangePctReduction()+n.debuffs.getVisionRangePctReduction())}),n.visionrangenight=ko.pureComputed(function(){return(n.heroData().visionnighttimerange+n.inventory.getVisionRangeNight()+n.ability().getVisionRangeNight())*(1+n.enemy().ability().getVisionRangePctReduction()+n.debuffs.getVisionRangePctReduction())}),n.lifesteal=ko.pureComputed(function(){var e=n.inventory.getLifesteal()+n.ability().getLifesteal()+TalentController.getLifesteal(n.selectedTalents())+n.buffs.getLifesteal();if("DOTA_UNIT_CAP_MELEE_ATTACK"==n.heroData().attacktype){var t=[n.inventory.getLifestealAura,n.buffs.itemBuffs.getLifestealAura].reduce(function(e,t){var a=t(e.excludeList);return a.value+=e.value,a},{value:0,excludeList:[]});e+=t.value}return e.toFixed(2)}),n.diffProperties=diffProperties,n.diff={};for(var o=0;o<n.diffProperties.length;o++){var i=o;n.diff[n.diffProperties[i]]=n.getDiffFunction(n.diffProperties[i])}};HeroModel.prototype.getDiffFunction=function(e){var t=this;return ko.computed(function(){return"baseDamage"==e?[t[e]()[0]-t.heroCompare()[e]()[0],t[e]()[1]-t.heroCompare()[e]()[1]]:t[e]()-t.heroCompare()[e]()},this,{deferEvaluation:!0})},HeroModel.prototype.getAbilityLevelMax=function(e){return"DOTA_ABILITY_TYPE_ATTRIBUTES"===e.abilitytype?1:"invoker_quas"===e.name||"invoker_wex"===e.name||"invoker_exort"===e.name?7:"invoker_invoke"===e.name?1:"earth_spirit_stone_caller"===e.name||"ogre_magi_unrefined_fireblast"===e.name||"monkey_king_mischief"===e.name?1:"DOTA_ABILITY_TYPE_ULTIMATE"===e.abilitytype||"keeper_of_the_light_recall"===e.name||"keeper_of_the_light_blinding_light"===e.name||"ember_spirit_activate_fire_remnant"===e.name||"lone_druid_true_form_battle_cry"===e.name?3:"puck_ethereal_jaunt"===e.name||"shadow_demon_shadow_poison_release"===e.name||"templar_assassin_trap"===e.name||"spectre_reality"===e.name?0:"invoker_cold_snap"===e.name||"invoker_ghost_walk"===e.name||"invoker_tornado"===e.name||"invoker_emp"===e.name||"invoker_alacrity"===e.name||"invoker_chaos_meteor"===e.name||"invoker_sun_strike"===e.name||"invoker_forge_spirit"===e.name||"invoker_ice_wall"===e.name||"invoker_deafening_blast"===e.name?0:"techies_minefield_sign"===e.name||"techies_focused_detonate"===e.name?0:4},HeroModel.prototype.toggleTalent=function(e,t){this.talents[e]()===t?this.talents[e](-1):(this.availableSkillPoints()>0||this.talents[e]()==1-t)&&parseInt(this.selectedHeroLevel())>=5*e+10&&this.talents[e](t)},module.exports=HeroModel;
...
module.exports={getBonusDamage:function(t){for(var e=0,a={},n=0;n<t.length;n++){var r=t[n];r.name.startsWith("special_bonus_attack_damage_")&&(e+=r.attributes[0].value[0],a[r.name]={damage:r.attributes[0].value[0],damageType:"physical",displayname:r.displayname})}return{sources:a,total:e}},getHealth:function(t){for(var e=0,a=0;a<t.length;a++){var n=t[a];n.name.startsWith("special_bonus_hp_")&&!n.name.startsWith("special_bonus_hp_regen_")&&(e+=n.attributes[0].value[0])}return e},getHealthRegen:function(t){for(var e=0,a=0;a<t.length;a++){var n=t[a];n.name.startsWith("special_bonus_hp_regen_")&&(e+=n.attributes[0].value[0])}return e},getMana:function(t){for(var e=0,a=0;a<t.length;a++){var n=t[a];n.name.startsWith("special_bonus_mp_")&&!n.name.startsWith("special_bonus_mp_regen_")&&(e+=n.attributes[0].value[0])}return e},getManaRegen:function(t){for(var e=0,a=0;a<t.length;a++){var n=t[a];n.name.startsWith("special_bonus_mp_regen_")&&(e+=n.attributes[0].value[0])}return e},getArmor:function(t){for(var e=0,a=0;a<t.length;a++){var n=t[a];n.name.startsWith("special_bonus_armor_")&&(e+=n.attributes[0].value[0])}return e},getSpellAmp:function(t){for(var e=0,a=0;a<t.length;a++){var n=t[a];n.name.startsWith("special_bonus_spell_amplify_")&&(e+=n.attributes[0].value[0])}return e},getCooldownReductionFlat:function(t){var e=0;return e},getCooldownReductionPercent:function(t){for(var e=1,a=0;a<t.length;a++){var n=t[a];n.name.startsWith("special_bonus_cooldown_reduction_")&&(e*=1-n.attributes[0].value[0]/100)}return e},getCooldownIncreaseFlat:function(t){var e=0;return e},getCooldownIncreasePercent:function(t){var e=1;return e},getMovementSpeedFlat:function(t){for(var e=0,a=0;a<t.length;a++){var n=t[a];n.name.startsWith("special_bonus_movement_speed_")&&(e+=n.attributes[0].value[0])}return e},getAttackRange:function(t){for(var e=0,a=0;a<t.length;a++){var n=t[a];n.name.startsWith("special_bonus_attack_range_")&&(e+=n.attributes[0].value[0])}return e},getAttackSpeed:function(t){for(var e=0,a=0;a<t.length;a++){var n=t[a];n.name.startsWith("special_bonus_attack_speed_")&&(e+=n.attributes[0].value[0])}return e},getLifesteal:function(t){for(var e=0,a=0;a<t.length;a++){var n=t[a];n.name.startsWith("special_bonus_lifesteal_")&&(e+=n.attributes[0].value[0])}return e},getEvasion:function(t){for(var e=1,a=0;a<t.length;a++){var n=t[a];n.name.startsWith("special_bonus_evasion_")&&(e*=1-n.attributes[0].value[0]/100)}return e},getMagicResist:function(t){for(var e=1,a=0;a<t.length;a++){var n=t[a];n.name.startsWith("special_bonus_magic_resistance_")&&(e*=1-n.attributes[0].value[0]/100)}return e},getRespawnReduction:function(t){for(var e=0,a=0;a<t.length;a++){var n=t[a];n.name.startsWith("special_bonus_respawn_reduction_")&&(e+=n.attributes[0].value[0])}return e},getStrength:function(t){for(var e=0,a=0;a<t.length;a++){var n=t[a];n.name.startsWith("special_bonus_strength_")?e+=n.attributes[0].value[0]:n.name.startsWith("special_bonus_all_stats_")&&(e+=n.attributes[0].value[0])}return e},getAgility:function(t){for(var e=0,a=0;a<t.length;a++){var n=t[a];n.name.startsWith("special_bonus_agility_")?e+=n.attributes[0].value[0]:n.name.startsWith("special_bonus_all_stats_")&&(e+=n.attributes[0].value[0])}return e},getIntelligence:function(t){for(var e=0,a=0;a<t.length;a++){var n=t[a];n.name.startsWith("special_bonus_intelligence_")?e+=n.attributes[0].value[0]:n.name.startsWith("special_bonus_all_stats_")&&(e+=n.attributes[0].value[0])}return e}};
...
(function (global){
var ko="undefined"!=typeof window?window.ko:"undefined"!=typeof global?global.ko:null,stackableItems=require("./stackableItems"),levelItems=require("./levelItems"),itemsWithActive=require("./itemsWithActive"),BasicInventoryViewModel=function(e){var t=this;t.items=ko.observableArray([]),t.activeItems=ko.observableArray([]),t.addItem=function(e,t){if(void 0!=e.selectedItem()){var i={item:e.selectedItem().split("|")[0],state:ko.observable(0),size:e.itemInputValue(),enabled:ko.observable(!0)};switch(i.item){case"dagon":i.size=Math.min(i.size,5);break;case"travel_boots":case"diffusal_blade":i.size=Math.min(i.size,2);break;case"necronomicon":i.size=Math.min(i.size,3)}this.items.push(i),"ring_of_aquila"!==e.selectedItem()&&"ring_of_basilius"!==e.selectedItem()&&"heart"!==e.selectedItem()||this.toggleItem(void 0,i,void 0)}}.bind(this),t.toggleItem=function(e,t,i){if(itemsWithActive.indexOf(t.item)>=0)switch(this.activeItems.indexOf(t)<0?this.activeItems.push(t):this.activeItems.remove(t),t.item){case"power_treads":t.state()<2?t.state(t.state()+1):t.state(0);break;default:0==t.state()?t.state(1):t.state(0)}}.bind(this),t.removeItem=function(e){this.activeItems.remove(e),this.items.remove(e)}.bind(this),t.toggleMuteItem=function(e){e.enabled(!e.enabled())}.bind(this),t.removeAll=function(){this.activeItems.removeAll(),this.items.removeAll()}.bind(this)};BasicInventoryViewModel.prototype.getItemImage=function(e){var t=ko.utils.unwrapObservable(e.state);switch(e.item){case"power_treads":return 0==t?"/media/images/items/"+e.item+"_str.png":1==t?"/media/images/items/"+e.item+"_int.png":"/media/images/items/"+e.item+"_agi.png";case"tranquil_boots":case"ring_of_basilius":return 0==t?"/media/images/items/"+e.item+".png":"/media/images/items/"+e.item+"_active.png";case"armlet":return 0==t?"/media/images/items/"+e.item+".png":"/media/images/items/"+e.item+"_active.png";case"ring_of_aquila":return 0==t?"/media/images/items/"+e.item+"_active.png":"/media/images/items/"+e.item+".png";case"dagon":case"diffusal_blade":case"travel_boots":case"necronomicon":return e.size>1?"/media/images/items/"+e.item+"_"+e.size+".png":"/media/images/items/"+e.item+".png";default:return"/media/images/items/"+e.item+".png"}},BasicInventoryViewModel.prototype.getItemSizeLabel=function(e){return stackableItems.indexOf(e.item)!=-1?'<span style="font-size:10px">Qty: </span>'+e.size:levelItems.indexOf(e.item)!=-1?'<span style="font-size:10px">Lvl: </span>'+e.size:"bloodstone"==e.item?'<span style="font-size:10px">Charges: </span>'+e.size:""},BasicInventoryViewModel.prototype.getActiveBorder=function(e){switch(e.item){case"power_treads":case"tranquil_boots":case"ring_of_basilius":case"ring_of_aquila":case"armlet":return 0;default:return ko.utils.unwrapObservable(e.state)}},BasicInventoryViewModel.prototype.getItemAttributeValue=function(e,t,i){for(var s=0;s<e.length;s++)if(e[s].name==t)return 0==i?parseFloat(e[s].value[0]):i>e[s].value.length?parseFloat(e[s].value[0]):parseFloat(e[s].value[i-1])},module.exports=BasicInventoryViewModel;
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})

},{"./itemsWithActive":32,"./levelItems":33,"./stackableItems":34}],27:[function(require,module,exports){
"use strict";var ko=require("../herocalc_knockout"),stackableItems=require("./stackableItems"),levelItems=require("./levelItems"),BasicInventoryViewModel=require("./BasicInventoryViewModel"),itemOptionsArray=require("./itemOptionsArray"),itemBuffOptions=require("./itemBuffOptions"),itemDebuffOptions=require("./itemDebuffOptions"),InventoryViewModel=function(e,t){var a=this;return BasicInventoryViewModel.call(this,t),a.hero=t,a.hasInventory=ko.observable(!0),a.items=ko.observableArray([]),a.activeItems=ko.observableArray([]),a.hasScepter=ko.computed(function(){for(var e=0;e<a.items().length;e++){var t=a.items()[e].item;if("ultimate_scepter"===t&&a.items()[e].enabled())return!0}return!1},this),a.isEthereal=ko.computed(function(){for(var e=0;e<a.items().length;e++){var t=a.items()[e].item,i=a.activeItems.indexOf(a.items()[e])>=0;if(("ghost"===t||"ethereal_blade"===t)&&a.items()[e].enabled()&&i)return!0}return!1},this),a.isSheeped=ko.computed(function(){for(var e=0;e<a.items().length;e++){var t=a.items()[e].item,i=a.activeItems.indexOf(a.items()[e])>=0;if("sheepstick"===t&&a.items()[e].enabled()&&i)return!0}return!1},this),a.totalCost=ko.computed(function(){for(var t=0,i=0;i<a.items().length;i++){var s=a.items()[i].item;if(a.items()[i].enabled())if(stackableItems.indexOf(s)!=-1)t+=e["item_"+s].itemcost*a.items()[i].size;else if(levelItems.indexOf(s)!=-1)switch(s){case"diffusal_blade":t+=e["item_"+s].itemcost+700*(a.items()[i].size-1);break;case"necronomicon":case"dagon":t+=e["item_"+s].itemcost+1250*(a.items()[i].size-1);break;default:t+=e["item_"+s].itemcost}else t+=e["item_"+s].itemcost}return t},this),a.addItemBuff=function(e,t){if(a.hasInventory()&&void 0!=a.selectedItemBuff()){var i={item:a.selectedItemBuff(),state:ko.observable(0),size:1,enabled:ko.observable(!0)};a.items.push(i),"ring_of_aquila"!==a.selectedItemBuff()&&"ring_of_basilius"!==a.selectedItemBuff()||a.toggleItem(void 0,i,void 0)}},a.addItemDebuff=function(e,t){if(a.hasInventory()&&void 0!=a.selectedItemDebuff()){var i={item:a.selectedItemDebuff().split("|")[0],state:ko.observable(0),size:1,enabled:ko.observable(!0)};2==a.selectedItemDebuff().split("|").length&&(i.debuff=a.selectedItemDebuff().split("|")[1]),a.items.push(i),"ring_of_aquila"!==a.selectedItemDebuff()&&"ring_of_basilius"!==a.selectedItemDebuff()||a.toggleItem(void 0,i,void 0)}},a.getAttributes=function(t){for(var i=0,s=0;s<a.items().length;s++){var n=a.items()[s].item,r=a.activeItems.indexOf(a.items()[s])>=0;if(a.items()[s].enabled())for(var m=a.items()[s].size,u=0;u<e["item_"+n].attributes.length;u++){var o=e["item_"+n].attributes[u];switch(o.name){case"bonus_all_stats":i+=parseInt(o.value[0]);break;case"bonus_stats":i+=parseInt(o.value[0])}switch(t){case"agi":"bonus_agility"==o.name&&(i+="diffusal_blade"==n?parseInt(o.value[m-1]):parseInt(o.value[0])),"bonus_stat"==o.name&&2==a.items()[s].state()&&(i+=parseInt(o.value[0])),"bonus_agi"==o.name&&(i+=parseInt(o.value[0]));break;case"int":"bonus_intellect"==o.name&&(i+="necronomicon"==n?parseInt(o.value[m-1]):"diffusal_blade"==n?parseInt(o.value[m-1]):"dagon"==n?parseInt(o.value[m-1]):parseInt(o.value[0])),"bonus_intelligence"==o.name&&(i+=parseInt(o.value[0])),"bonus_int"==o.name&&(i+=parseInt(o.value[0])),"bonus_stat"==o.name&&1==a.items()[s].state()&&(i+=parseInt(o.value[0]));break;case"str":"bonus_strength"==o.name&&(i+="necronomicon"==n?parseInt(o.value[m-1]):parseInt(o.value[0])),"bonus_stat"==o.name&&0==a.items()[s].state()&&(i+=parseInt(o.value[0])),"bonus_str"==o.name&&(i+=parseInt(o.value[0])),"unholy_bonus_strength"==o.name&&r&&(i+=parseInt(o.value[0]))}}}return i},a.getBash=function(t){for(var i=1,s=0;s<a.items().length;s++){var n=a.items()[s].item;if(a.items()[s].enabled())for(var r=0;r<e["item_"+n].attributes.length;r++){var m=e["item_"+n].attributes[r];switch(m.name){case"bash_chance":i*=1-parseInt(m.value[0])/100;break;case"bash_chance_melee":"DOTA_UNIT_CAP_MELEE_ATTACK"==t&&(i*=1-parseInt(m.value[0])/100);break;case"bash_chance_ranged":"DOTA_UNIT_CAP_RANGED_ATTACK"==t&&(i*=1-parseInt(m.value[0])/100)}}}return i},a.getCritChance=function(){for(var t=1,i=0;i<a.items().length;i++){var s=a.items()[i].item;a.activeItems.indexOf(a.items()[i])>=0;if(a.items()[i].enabled())for(var n=0;n<e["item_"+s].attributes.length;n++){var r=e["item_"+s].attributes[n];switch(r.name){case"crit_chance":t*=1-parseInt(r.value[0])/100}}}return t},a.getCritSource=function(){for(var t={},i=0;i<a.items().length;i++){var s=a.items()[i].item,n=a.activeItems.indexOf(a.items()[i])>=0;if(a.items()[i].enabled()){switch(s){case"lesser_crit":case"greater_crit":case"bloodthorn":void 0==t[s]?t[s]={chance:a.getItemAttributeValue(e["item_"+s].attributes,"crit_chance",0)/100,multiplier:a.getItemAttributeValue(e["item_"+s].attributes,"crit_multiplier",0)/100,count:1,displayname:e["item_"+s].displayname}:t[s].count+=1}"bloodthorn"===s&&n&&(void 0==t.soul_rend?t.soul_rend={chance:1,multiplier:a.getItemAttributeValue(e["item_"+s].attributes,"target_crit_multiplier",0)/100,count:1,displayname:"Soul Rend"}:t.soul_rend.count+=1)}}return t},a.getCleaveSource=function(){for(var t={},i=0;i<a.items().length;i++){var s=a.items()[i].item;a.activeItems.indexOf(a.items()[i])>=0;if(a.items()[i].enabled())switch(s){case"bfury":void 0==t[s]?t[s]={radius:a.getItemAttributeValue(e["item_"+s].attributes,"cleave_radius",0),magnitude:a.getItemAttributeValue(e["item_"+s].attributes,"cleave_damage_percent",0)/100,count:1,displayname:e["item_"+s].displayname}:t[s].count+=1}}return t},a.getBashSource=function(t){for(var i={},s=0;s<a.items().length;s++){var n=a.items()[s].item;a.activeItems.indexOf(a.items()[s])>=0;if(a.items()[s].enabled())switch(n){case"javelin":void 0==i[n]?i[n]={damage:a.getItemAttributeValue(e["item_"+n].attributes,"bonus_chance_damage",1),damageType:"magic",count:1,chance:a.getItemAttributeValue(e["item_"+n].attributes,"bonus_chance",1)/100,displayname:e["item_"+n].displayname+" Pierce"}:i[n].count+=1;break;case"monkey_king_bar":void 0==i[n]?i[n]={item:n,chance:a.getItemAttributeValue(e["item_"+n].attributes,"bash_chance",0)/100,damage:a.getItemAttributeValue(e["item_"+n].attributes,"bash_damage",0),duration:a.getItemAttributeValue(e["item_"+n].attributes,"bash_stun",0),count:1,damageType:"magic",displayname:"Mini-Bash"}:i[n].count+=1;break;case"abyssal_blade":case"basher":i.hasOwnProperty("bash")||(i.bash={item:n,chance:a.getItemAttributeValue(e["item_"+n].attributes,"DOTA_UNIT_CAP_MELEE_ATTACK"==t?"bash_chance_melee":"bash_chance_ranged",0)/100,damage:a.getItemAttributeValue(e["item_"+n].attributes,"bonus_chance_damage",0),duration:a.getItemAttributeValue(e["item_"+n].attributes,"bash_duration",0),count:1,damageType:"physical",displayname:"Bash"})}}return i},a.getOrbProcSource=function(){for(var t={},i=0;i<a.items().length;i++){var s=a.items()[i].item;a.activeItems.indexOf(a.items()[i])>=0;if(a.items()[i].enabled())switch(s){case"maelstrom":case"mjollnir":void 0==t[s]?t[s]={chance:a.getItemAttributeValue(e["item_"+s].attributes,"chain_chance",0)/100,damage:a.getItemAttributeValue(e["item_"+s].attributes,"chain_damage",0),count:1,damageType:"magic",displayname:e["item_"+s].displayname}:t[s].count+=1}}return t},a.getOrbSource=function(){for(var t={},i=0;i<a.items().length;i++){var s=a.items()[i].item;a.activeItems.indexOf(a.items()[i])>=0;if(a.items()[i].enabled())switch(s){case"diffusal_blade":void 0==t[s]?t[s]={chance:1,damage:a.getItemAttributeValue(e["item_"+s].attributes,"feedback_mana_burn",a.items()[i].size),count:1,damageType:"physical",displayname:e["item_"+s].displayname}:t[s].count+=1}}return t},a.getHealth=function(){for(var t=0,i=0;i<a.items().length;i++){var s=a.items()[i].item;if(a.items()[i].enabled())for(var n=0;n<e["item_"+s].attributes.length;n++){var r=e["item_"+s].attributes[n];switch(r.name){case"bonus_health":t+=parseInt(r.value[0])}}}return t},a.getHealthRegen=function(){for(var t=0,i=0;i<a.items().length;i++){var s=a.items()[i].item,n=a.activeItems.indexOf(a.items()[i])>=0;if(a.items()[i].enabled())for(var r=0;r<e["item_"+s].attributes.length;r++){var m=e["item_"+s].attributes[r];switch(m.name){case"health_regen":case"bonus_regen":t+=parseInt(m.value[0]);break;case"bonus_health_regen":"tranquil_boots"!=s||n?"tranquil_boots"!=s&&(t+=parseInt(m.value[0])):t+=parseInt(m.value[0]);break;case"hp_regen":t+=parseInt(m.value[0]);break;case"health_regen_rate":"heart"==s&&n&&(t+=parseInt(m.value[0])/100*a.hero.health())}}}return t},a.getHealthRegenAura=function(t){for(var i=0,s=t||[],n=0;n<a.items().length;n++){var r=a.items()[n].item;a.activeItems.indexOf(a.items()[n])>=0;if(a.items()[n].enabled())for(var m=0;m<e["item_"+r].attributes.length;m++){var u=e["item_"+r].attributes[m];if(!(s.indexOf(r+u.name)>-1))switch(u.name){case"aura_health_regen":i+=parseInt(u.value[0]),s.push(r+u.name)}}}return{value:i,excludeList:s}},a.getMana=function(){for(var t=0,i=0;i<a.items().length;i++){var s=a.items()[i].item;if(a.items()[i].enabled())for(var n=0;n<e["item_"+s].attributes.length;n++){var r=e["item_"+s].attributes[n];switch(r.name){case"bonus_mana":t+=parseInt(r.value[0])}}}return t},a.getManaRegen=function(){for(var t=0,i=0;i<a.items().length;i++){var s=a.items()[i].item;if(a.items()[i].enabled())for(var n=0;n<e["item_"+s].attributes.length;n++){var r=e["item_"+s].attributes[n];switch(r.name){case"aura_mana_regen":case"mana_regen_aura":t+=parseFloat(r.value[0]);break;case"mana_regen":"infused_raindrop"==s&&(t+=parseFloat(r.value[0]))}}}return t},a.getManaRegenPercent=function(){for(var t=0,i=0;i<a.items().length;i++){var s=a.items()[i].item;if(a.items()[i].enabled())for(var n=0;n<e["item_"+s].attributes.length;n++){var r=e["item_"+s].attributes[n];switch(r.name){case"bonus_mana_regen":case"mana_regen":case"bonus_mana_regen_pct":"infused_raindrop"!=s&&(t+=parseFloat(r.value[0]))}}}return t/100},a.getManaRegenBloodstone=function(){for(var e=0;e<a.items().length;e++){var t=a.items()[e].item;if(a.items()[e].enabled()&&t.indexOf("bloodstone")!=-1)return parseInt(a.items()[e].size)}return 0},a.getArmor=function(){for(var t=0,i=0;i<a.items().length;i++){var s=a.items()[i].item,n=a.activeItems.indexOf(a.items()[i])>=0;if(a.items()[i].enabled())for(var r=0;r<e["item_"+s].attributes.length;r++){var m=e["item_"+s].attributes[r];switch(m.name){case"bonus_armor":(!n||"medallion_of_courage"!=s&&"solar_crest"!=s)&&(t+=parseInt(m.value[0]));break;case"unholy_bonus_armor":n&&"armlet"==s&&(t+=parseInt(m.value[0]))}}}return t},a.getArmorAura=function(t){for(var i=0,s=t||[],n=0;n<a.items().length;n++){var r=a.items()[n].item,m=a.activeItems.indexOf(a.items()[n])>=0;if(a.items()[n].enabled())for(var u=0;u<e["item_"+r].attributes.length;u++){var o=e["item_"+r].attributes[u];if(!s.find(function(e){return o.name==e.name}))switch(o.name){case"bonus_aoe_armor":m&&s.push({name:o.name,value:parseInt(o.value[0])});break;case"aura_positive_armor":s.push({name:o.name,value:parseInt(o.value[0])});break;case"aura_bonus_armor":m&&s.push({name:o.name,value:parseInt(o.value[0])});break;case"armor_aura":s.push({name:o.name,value:parseInt(o.value[0])});break;case"heal_bonus_armor":m&&s.push({name:o.name,value:parseInt(o.value[0])})}}}return s.find(function(e){return"heal_bonus_armor"==e.name})&&(s=s.filter(function(e){return"bonus_aoe_armor"!==e.name})),s.find(function(e){return"armor_aura"==e.name})&&(s=s.filter(function(e){return"aura_bonus_armor"!==e.name})),i=s.reduce(function(e,t){return e+=t.value},0),{value:i,attributes:s}},a.getArmorReduction=function(t){for(var i=0,s=t||[],n=[],r=0;r<a.items().length;r++){var m=a.items()[r].item,u=a.activeItems.indexOf(a.items()[r])>=0;if(a.items()[r].enabled())for(var o=0;o<e["item_"+m].attributes.length;o++){var l=e["item_"+m].attributes[o];if(!(s.indexOf(l.name)>-1||s.indexOf(m+"_"+l.name)>-1||a.hero&&(n.indexOf(l.name)>-1||n.indexOf(m+"_"+l.name)>-1)))switch(l.name){case"armor_reduction":(u||"medallion_of_courage"!=m&&"solar_crest"!=m)&&(i+=parseInt(l.value[0]),s.push(m+"_"+l.name));break;case"aura_negative_armor":i+=parseInt(l.value[0]),s.push(l.name);break;case"corruption_armor":i+=parseInt(l.value[0]),s.push(m+"_"+l.name),n.push(l.name)}}}return{value:i,excludeList:s}},a.getEvasion=function(){for(var t=1,i=0;i<a.items().length;i++){var s=a.items()[i].item,n=a.activeItems.indexOf(a.items()[i])>=0;if(a.items()[i].enabled())for(var r=0;r<e["item_"+s].attributes.length;r++){var m=e["item_"+s].attributes[r];switch(m.name){case"bonus_evasion":(!n||"butterfly"!=s&&"solar_crest"!=s)&&(t*=1-parseInt(m.value[0])/100)}}}return t},a.getMovementSpeedFlat=function(){for(var t=0,i=!1,s=!1,n=!1,r=["boots","phase_boots","arcane_boots","travel_boots","power_treads","tranquil_boots","guardian_greaves"],m=0;m<a.items().length;m++){var u=a.items()[m].item,o=a.activeItems.indexOf(a.items()[m])>=0;if(a.items()[m].enabled())for(var l=0;l<e["item_"+u].attributes.length;l++){var c=e["item_"+u].attributes[l];switch(c.name){case"bonus_movement_speed":!i&&r.indexOf(u)>=0?("tranquil_boots"!=u||"tranquil_boots"==u&&!o)&&(t+=parseInt(c.value[0]),i=!0):"cyclone"==u&&(t+=parseInt(c.value[0]),s=!0);break;case"broken_movement_speed":!i&&r.indexOf(u)>=0&&"tranquil_boots"==u&&o&&(t+=parseInt(c.value[0]),i=!0);break;case"bonus_movement":!i&&r.indexOf(u)>=0&&(t+=parseInt(c.value[0]),i=!0);break;case"movement_speed":n||"wind_lace"!=u||(t+=parseInt(c.value[0]),n=!0)}}}return t},a.getMovementSpeedPercent=function(t){for(var i=0,s=t||[],n=!1,r=!1,m=!1,u=!1,o=!1,l=!1,c=!1,v=["manta","yasha","sange_and_yasha"],_=0;_<a.items().length;_++){var b=a.items()[_].item,f=a.activeItems.indexOf(a.items()[_])>=0;if(a.items()[_].enabled())for(var d=0;d<e["item_"+b].attributes.length;d++){var p=e["item_"+b].attributes[d];if(!(s.indexOf(p.name)>-1))switch(p.name){case"movement_speed_percent_bonus":!n&&v.indexOf(b)>=0&&(i+=parseInt(p.value[0]),n=!0);break;case"bonus_aura_movement_speed_pct":r||"ancient_janggo"!=b||(i+=parseInt(p.value[0]),r=!0,s.push(p.name));break;case"phase_movement_speed":f&&!u&&(i+=parseInt(p.value[0]),u=!0);break;case"bonus_movement_speed_pct":f&&!m&&"ancient_janggo"==b&&(i+=parseInt(p.value[0]),m=!0,s.push(p.name));break;case"windwalk_movement_speed":!f||o||"invis_sword"!=b&&"silver_edge"!=b||(i+=parseInt(p.value[0]),o=!0);break;case"berserk_bonus_movement_speed":f&&!c&&"mask_of_madness"==b&&(i+=parseInt(p.value[0]),c=!0);break;case"bonus_movement_speed":n||"manta"!=b?"smoke_of_deceit"==b&&f&&(i+=parseInt(p.value[0])):(i+=parseInt(p.value[0]),n=!0);break;case"bonus_move_speed":f&&!l&&"butterfly"==b&&(i+=parseInt(p.value[0]),l=!0)}}}return{value:i/100,excludeList:s}},a.getMovementSpeedPercentReduction=function(t){for(var i=0,s=t||[],n=0;n<a.items().length;n++){var r=a.items()[n].item,m=a.activeItems.indexOf(a.items()[n])>=0;if(a.items()[n].enabled())for(var u=0;u<e["item_"+r].attributes.length;u++){var o=e["item_"+r].attributes[u];if(!(s.indexOf(o.name)>-1))switch(o.name){case"movespeed":"dust"==r&&m&&(i+=parseInt(o.value[0]));case"blast_movement_speed":"shivas_guard"==r&&m&&(i+=parseInt(o.value[0]),s.push(o.name));case"cold_movement_speed":"skadi"==r&&(i+=parseInt(o.value[0]));break;case"maim_movement_speed":a.items()[n].debuff&&"maim"==a.items()[n].debuff&&(i+=parseInt(o.value[0]),s.push(o.name))}}}return{value:i/100,excludeList:s}},a.getBonusDamage=function(){for(var t=0,i={},s=0;s<a.items().length;s++){var n=a.items()[s].item,r=a.activeItems.indexOf(a.items()[s])>=0;if(a.items()[s].enabled())for(var m=0;m<e["item_"+n].attributes.length;m++){var u=e["item_"+n].attributes[m];switch(u.name){case"bonus_damage":t+=parseInt(u.value[0]),void 0==i[n]?i[n]={damage:parseInt(u.value[0]),damageType:"physical",count:1,displayname:e["item_"+n].displayname}:i[n].count+=1;break;case"unholy_bonus_damage":r&&(t+=parseInt(u.value[0]),void 0==i[n+"_active"]?i[n+"_active"]={damage:parseInt(u.value[0]),damageType:"physical",count:1,displayname:e["item_"+n].displayname+" Unholy Strength"}:i[n].count+=1)}}}return{sources:i,total:t}},a.getBonusDamagePercent=function(t){t=t||{sources:{},total:0};for(var i=t.total||0,s=t.sources||{},n=0;n<a.items().length;n++){var r=a.items()[n].item;a.activeItems.indexOf(a.items()[n])>=0;if(a.items()[n].enabled())for(var m=0;m<e["item_"+r].attributes.length;m++){var u=e["item_"+r].attributes[m];switch(u.name){case"damage_aura":void 0==s[r]&&(i+=parseInt(u.value[0])/100,s[r]={damage:parseInt(u.value[0])/100,damageType:"physical",count:1,displayname:e["item_"+r].displayname});break;case"bottle_doubledamage":void 0==s[r]&&(i+=parseInt(u.value[0])/100,s[r]={damage:parseInt(u.value[0])/100,damageType:"physical",count:1,displayname:e["item_"+r].displayname})}}}return{sources:s,total:i}},a.getAttackSpeed=function(t){for(var i=0,s=!1,n=t||[],r=0;r<a.items().length;r++){var m=a.items()[r].item,u=a.activeItems.indexOf(a.items()[r])>=0;if(a.items()[r].enabled())for(var o=0;o<e["item_"+m].attributes.length;o++){var l=e["item_"+m].attributes[o];if(!(n.indexOf(l.name)>-1))switch(l.name){case"bonus_attack_speed":"power_treads"==m?s||(i+=parseInt(l.value[0]),s=!0):"moon_shard"==m?u||(i+=parseInt(l.value[0])):"hurricane_pike"==m?u&&(i+=parseInt(l.value[0])):i+=parseInt(l.value[0]);break;case"consumed_bonus":"moon_shard"==m&&u&&(i+=parseInt(l.value[0]));break;case"bonus_speed":i+=parseInt(l.value[0]);break;case"aura_attack_speed":"shivas_guard"!=m&&(i+=parseInt(l.value[0]));break;case"bonus_aura_attack_speed_pct":i+=parseInt(l.value[0]),n.push(l.name);break;case"bonus_attack_speed_pct":u&&(i+=parseInt(l.value[0]),n.push(l.name));break;case"unholy_bonus_attack_speed":u&&(i+=parseInt(l.value[0]));break;case"berserk_bonus_attack_speed":u&&(i+=parseInt(l.value[0]))}}}return{value:i,excludeList:n}},a.getAttackSpeedReduction=function(t){for(var i=0,s=t||[],n=0;n<a.items().length;n++){var r=a.items()[n].item;a.activeItems.indexOf(a.items()[n])>=0;if(a.items()[n].enabled())for(var m=0;m<e["item_"+r].attributes.length;m++){var u=e["item_"+r].attributes[m];if(!(s.indexOf(u.name)>-1))switch(u.name){case"aura_attack_speed":"shivas_guard"==r&&(i+=parseInt(u.value[0]),s.push(u.name));break;case"cold_attack_speed":"skadi"==r&&(i+=parseInt(u.value[0]),s.push(u.name));break;case"maim_attack_speed":a.items()[n].debuff&&"maim"==a.items()[n].debuff&&(i+=parseInt(u.value[0]),s.push(u.name))}}}return{value:i,excludeList:s}},a.getLifesteal=function(){for(var t=0,i=0;i<a.items().length;i++){var s=a.items()[i].item,n=a.activeItems.indexOf(a.items()[i])>=0;if(a.items()[i].enabled())for(var r=0;r<e["item_"+s].attributes.length;r++){var m=e["item_"+s].attributes[r];switch(m.name){case"lifesteal_percent":if("satanic"!=s)return parseInt(m.value[0]);if(!n)return parseInt(m.value[0]);break;case"unholy_lifesteal_percent":if(n)return parseInt(m.value[0])}}}return t},a.getLifestealAura=function(t){for(var i=0,s=t||[],n=0;n<a.items().length;n++){var r=a.items()[n].item;a.activeItems.indexOf(a.items()[n])>=0;if(a.items()[n].enabled())for(var m=0;m<e["item_"+r].attributes.length;m++){var u=e["item_"+r].attributes[m];if(!(s.indexOf(u.name)>-1))switch(u.name){case"vampiric_aura":i+=parseInt(u.value[0]),s.push(u.name)}}}return{value:i,excludeList:s}},a.getSpellAmp=ko.computed(function(){for(var t=0,i=0;i<a.items().length;i++){var s=a.items()[i].item;a.activeItems.indexOf(a.items()[i])>=0;if(a.items()[i].enabled())for(var n=0;n<e["item_"+s].attributes.length;n++){var r=e["item_"+s].attributes[n];switch(r.name){case"spell_amp":t+=parseInt(r.value[0])}}}return t}),a.getCooldownReductionFlat=ko.computed(function(){var e=0;return e}),a.getCooldownReductionPercent=function(t){for(var i=1,s=t||[],n=0;n<a.items().length;n++){var r=a.items()[n].item;a.activeItems.indexOf(a.items()[n])>=0;if(a.items()[n].enabled())for(var m=0;m<e["item_"+r].attributes.length;m++){var u=e["item_"+r].attributes[m];if(!s.find(function(e){return u.name==e.name}))switch(u.name){case"bonus_cooldown":s.push({name:u.name,value:parseInt(u.value[0])})}}}return i=s.reduce(function(e,t){return e*=1-t.value/100},1),{value:i,attributes:s}},a.getCooldownIncreaseFlat=ko.computed(function(){var e=0;return e}),a.getCooldownIncreasePercent=function(){var e=1;return e},a.getMagicResist=function(){for(var t=1,i=0;i<a.items().length;i++){var s=a.items()[i].item;a.activeItems.indexOf(a.items()[i])>=0;if(a.items()[i].enabled())for(var n=0;n<e["item_"+s].attributes.length;n++){var r=e["item_"+s].attributes[n];switch(r.name){case"bonus_magical_armor":t*=1-parseInt(r.value[0])/100;break;case"bonus_spell_resist":t*=1-parseInt(r.value[0])/100;break;case"magic_resistance":t*=1-parseInt(r.value[0])/100}}}return t},a.getMagicResistReductionSelf=function(){for(var t=1,i=0;i<a.items().length;i++){var s=a.items()[i].item,n=a.activeItems.indexOf(a.items()[i])>=0;if(a.items()[i].enabled()&&n)for(var r=0;r<e["item_"+s].attributes.length;r++){var m=e["item_"+s].attributes[r];switch(m.name){case"extra_spell_damage_percent":case"ethereal_damage_bonus":return 1-parseInt(m.value[0])/100}}}return t},a.getMagicResistReduction=function(){for(var t=1,i=0;i<a.items().length;i++){var s=a.items()[i].item,n=a.activeItems.indexOf(a.items()[i])>=0;if(a.items()[i].enabled()&&n)for(var r=0;r<e["item_"+s].attributes.length;r++){var m=e["item_"+s].attributes[r];switch(m.name){case"ethereal_damage_bonus":a.isEthereal()||(t*=1-parseInt(m.value[0])/100);case"resist_debuff":t*=1-parseInt(m.value[0])/100}}}return t},a.getVisionRangeNight=ko.computed(function(){for(var t=0,i=0;i<a.items().length;i++){var s=a.items()[i].item,n=a.activeItems.indexOf(a.items()[i])>=0;if(a.items()[i].enabled())for(var r=0;r<e["item_"+s].attributes.length;r++){var m=e["item_"+s].attributes[r];switch(m.name){case"bonus_night_vision":"moon_shard"==s&&n||(t+=parseInt(m.value[0]))}}}return t}),a.getAttackRange=function(t,i){for(var s=0,n=i||[],r=0;r<a.items().length;r++){var m=a.items()[r].item;a.activeItems.indexOf(a.items()[r])>=0;if(a.items()[r].enabled())for(var u=0;u<e["item_"+m].attributes.length;u++){var o=e["item_"+m].attributes[u];if(!n.find(function(e){return o.name==e.name}))switch(o.name){case"base_attack_range":"DOTA_UNIT_CAP_RANGED_ATTACK"==t&&n.push({name:o.name,value:parseInt(o.value[0])})}}}return s=n.reduce(function(e,t){return e+=t.value},0),{value:s,attributes:n}},a.getMissChance=function(t){for(var i=1,s=t||[],n=0;n<a.items().length;n++){var r=a.items()[n].item,m=a.activeItems.indexOf(a.items()[n])>=0;if(a.items()[n].enabled())for(var u=0;u<e["item_"+r].attributes.length;u++){var o=e["item_"+r].attributes[u];if(!(s.indexOf(o.name)>-1))switch(o.name){case"miss_chance":"solar_crest"===r&&m&&(i*=1-parseInt(o.value[0])/100,s.push(o.name));break;case"blind_pct":i*=1-parseInt(o.value[0])/100,s.push(o.name)}}}return{value:i,excludeList:s}},a.getBaseDamageReductionPct=function(){for(var t=1,i=0;i<a.items().length;i++){var s=a.items()[i].item;a.activeItems.indexOf(a.items()[i])>=0;if(a.items()[i].enabled())for(var n=0;n<e["item_"+s].attributes.length;n++){var r=e["item_"+s].attributes[n];switch(r.name){case"backstab_reduction":a.items()[i].debuff&&"shadow_walk"==a.items()[i].debuff&&(t*=1+parseInt(r.value[0])/100)}}}return t},a.getBonusDamageReductionPct=function(){for(var t=1,i=0;i<a.items().length;i++){var s=a.items()[i].item;a.activeItems.indexOf(a.items()[i])>=0;if(a.items()[i].enabled())for(var n=0;n<e["item_"+s].attributes.length;n++){var r=e["item_"+s].attributes[n];switch(r.name){case"backstab_reduction":a.items()[i].debuff&&"shadow_walk"==a.items()[i].debuff&&(t*=1+parseInt(r.value[0])/100)}}}return t},a.itemOptions=ko.observableArray(itemOptionsArray.items),a.itemBuffOptions=ko.observableArray(itemBuffOptions.items),a.selectedItemBuff=ko.observable("assault"),a.itemDebuffOptions=ko.observableArray(itemDebuffOptions.items),a.selectedItemDebuff=ko.observable("assault"),a};InventoryViewModel.prototype=Object.create(BasicInventoryViewModel.prototype),InventoryViewModel.prototype.constructor=InventoryViewModel,module.exports=InventoryViewModel;
...
(function (global){
var ko="undefined"!=typeof window?window.ko:"undefined"!=typeof global?global.ko:null,ItemInput=function(e,s,a,o){if(e["item_"+s].ItemAliases instanceof Array)var i=e["item_"+s].ItemAliases.join(" ");else var i=e["item_"+s].ItemAliases;this.value=ko.observable(s),this.debuff=ko.observable(o),this.debuff()?(this.value=ko.observable(s+"|"+o.id),this.name=ko.observable(a+" ("+o.name+")"),this.displayname=ko.observable(a+" ("+o.name+') <span style="display:none">;'+i+"</span>")):(this.value=ko.observable(s),this.name=ko.observable(a),this.displayname=ko.observable(a+' <span style="display:none">;'+i+"</span>"))};module.exports=ItemInput;
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})

},{}],29:[function(require,module,exports){
var ItemInput=require("./ItemInput"),itemBuffs=["assault","ancient_janggo","headdress","mekansm","pipe","ring_of_aquila","vladmir","ring_of_basilius","buckler","solar_crest","bottle_doubledamage"],itemBuffOptions={},init=function(i){return itemBuffOptions.items=itemBuffs.map(function(t){return new ItemInput(i,t,i["item_"+t].displayname)}).sort(function(i,t){return i.displayname()<t.displayname()?-1:i.displayname()>t.displayname()?1:0}),itemBuffOptions.items};itemBuffOptions.init=init,module.exports=itemBuffOptions;
},{"./ItemInput":28}],30:[function(require,module,exports){
var ItemInput=require("./ItemInput"),itemDebuffs=[{item:"assault",debuff:null},{item:"shivas_guard",debuff:null},{item:"desolator",debuff:null},{item:"blight_stone",debuff:null},{item:"medallion_of_courage",debuff:null},{item:"radiance",debuff:null},{item:"sheepstick",debuff:null},{item:"veil_of_discord",debuff:null},{item:"solar_crest",debuff:null},{item:"silver_edge",debuff:{id:"shadow_walk",name:"Shadow Walk"}},{item:"silver_edge",debuff:{id:"maim",name:"Lesser Maim"}}],itemDebuffOptions={},init=function(e){return itemDebuffOptions.items=itemDebuffs.map(function(i){return new ItemInput(e,i.item,e["item_"+i.item].displayname,i.debuff)}).sort(function(e,i){return e.displayname()<i.displayname()?-1:e.displayname()>i.displayname()?1:0}),itemDebuffOptions.items};itemDebuffOptions.init=init,module.exports=itemDebuffOptions;
...
(function (global){
"use strict";var ko="undefined"!=typeof window?window.ko:"undefined"!=typeof global?global.ko:null,HeroCalc=require("dota-hero-calculator-library"),DamageAmpViewModel=require("./DamageAmpViewModel"),HeroDamageAmpMixin=require("./HeroDamageAmpMixin"),CloneViewModel=function(e,o,l,a,i){var r=this;HeroCalc.CloneModel.call(this,e,o,a,i),r.bound=ko.observable(!1),r.inventory=i.inventory,r.sectionDisplay=ko.observable({inventory:ko.observable(!0),ability:ko.observable(!0),buff:ko.observable(!0),debuff:ko.observable(!0),damageamp:ko.observable(!1),illusion:ko.observable(!1),skillbuild:ko.observable(!1),"skillbuild-skills":ko.observable(!0),"skillbuild-items":ko.observable(!0)}),r.sectionDisplayToggle=function(e){r.sectionDisplay()[e](!r.sectionDisplay()[e]())},r.showUnitTab=ko.observable(!1),r.showDiff=ko.observable(!1),r.showCriticalStrikeDetails=ko.observable(!1),r.showDamageDetails=ko.observable(!1),r.showStatDetails=ko.observable(!1),r.showDamageAmpCalcDetails=ko.observable(!1),r.damageAmplification=new DamageAmpViewModel(e,o,l),r.damageReduction=new DamageAmpViewModel(e,o,l),HeroDamageAmpMixin(r)};CloneViewModel.prototype=Object.create(HeroCalc.CloneModel.prototype),CloneViewModel.prototype.constructor=CloneViewModel,module.exports=CloneViewModel;
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
...
Array.prototype.find||(Array.prototype.find=function(t){"use strict";if(null==this)throw new TypeError("Array.prototype.find called on null or undefined");if("function"!=typeof t)throw new TypeError("predicate must be a function");for(var r,n=Object(this),e=n.length>>>0,o=arguments[1],i=0;i<e;i++)if(r=n[i],t.call(o,r,i,n))return r}),String.prototype.startsWith||(String.prototype.startsWith=function(t,r){return r=r||0,this.substr(r,t.length)===t});
},{}],85:[function(require,module,exports){
function AttributeTooltip(t,i,e,a){this.tooltip=t,this.values=i,this.sep=e||" / ",this.suffix=a||""}function ViewModel(t){var i=this;i.hero=t.hero,i.ability=t.ability,i.description=ko.computed(function(){return getTooltipAbilityDescription(i.ability)}),i.damageType=abilityDamageTypes[i.ability.abilityunitdamagetype],i.displayname=i.ability.displayname,i.lore=ko.computed(function(){return abilityTooltipData()?abilityTooltipData()[i.ability.name].lore:""}),i.manacost=ko.computed(function(){return getTooltipAbilityManaCost(i.hero,i.ability)}),i.cooldown=ko.computed(function(){return getTooltipAbilityCooldown(i.hero,i.ability)}),i.attributes=getTooltipAbilityAttributes(i.ability)}var abilityDamageTypes={DAMAGE_TYPE_MAGICAL:"Magical",DAMAGE_TYPE_PURE:"Pure",DAMAGE_TYPE_PHYSICAL:"Physical",DAMAGE_TYPE_COMPOSITE:"Composite",DAMAGE_TYPE_HP_REMOVAL:"HP Removal"},abilityTooltipData=ko.observable(),getTooltipAbilityDescription=function(t){for(var i=abilityTooltipData()?abilityTooltipData()[t.name].description:"",e=0;e<t.attributes.length;e++)if(null!=t.attributes[e].name){for(var a=t.attributes[e].name,o=t.attributes[e].value[0],n=1;n<t.attributes[e].value.length;n++)o+=" / "+t.attributes[e].value[n];l=new RegExp("%"+a+"%","gi"),i=i.replace(l,o)}var l=new RegExp("%%","gi");return i=i.replace(l,"%"),l=new RegExp("\n","gi"),i=i.replace(/\\n/g,"<br>")};AttributeTooltip.prototype.toString=function(){var t=this;return this.tooltip+" "+this.values.map(function(i){return i+t.suffix}).join(this.sep)};var getTooltipAbilityAttributes=function(t){var i=[];t.damage.length>0&&t.damage.reduce(function(t,i){return t+i},0)>0&&i.push(new AttributeTooltip("DAMAGE:",t.damage));for(var e=0;e<t.attributes.length;e++)if(null!=t.attributes[e].tooltip){var a=t.attributes[e].tooltip;a=a.replace(/\\n/g,"");var o="";0==a.indexOf("%")&&(a=a.slice(1),o="%"),i.push(new AttributeTooltip(a,t.attributes[e].value," / ",o))}return i},getTooltipAbilityManaCost=function(t,i){var e="";if(0==i.manacost.reduce(function(t,i){return t+i},0))return e;if(i.manacost.every(function(t){return t==i.manacost[0]}))return i.manacost[0].toString();for(var a=0;a<4;a++)null!=i.manacost[a]&&(e=e+" "+i.manacost[a]);return e},getTooltipAbilityCooldown=function(t,i){var e="";return 0==i.cooldown.reduce(function(t,i){return t+i},0)?e:i.cooldown.map(function(i){return parseFloat((i*t.cooldownReductionProduct()-t.cooldownReductionFlat()).toFixed(2))}).join(" ")};module.exports={viewModel:ViewModel,template:'<div>\n    <span class="item_field pull-left item_name" data-bind="text: displayname"></span>\n    <span class="item_field pull-right item_ability_damage_type" style="margin-right: 10px;"  data-bind="text: damageType"></span>\n    <hr style="clear: both;">\n    <div class="item_field item_description" data-bind="html: description"></div>\n    <div class="item_field item_attributes" data-bind="foreach: attributes">\n        <span data-bind="text: $data"></span>\n        <br>\n    </div>\n    <div class="item_cdmana">\n        <span class="item_field item_manacost" data-bind="visible: manacost, text: manacost"></span>\n        <span class="item_field item_cooldown" data-bind="visible: cooldown, text: cooldown"></span>\n    </div>\n    <div class="item_field item_lore" data-bind="text: lore"></div>\n</div>',abilityTooltipData:abilityTooltipData};
